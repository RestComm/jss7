...
public class InvokeTest  {
	...
	public void testDecodeWithParaSequ() throws IOException, ParseException {
		...
		assertTrue(Arrays.equals(new byte[] { 0x04, 0x01, 0x0f, 0x04, 0x10, (byte) 0xaa, (byte) 0x98, (byte) 0xac, (byte) 0xa6, 0x5a, (byte) 0xcd, 0x62, 0x36,
				0x19, 0x0e, 0x37, (byte) 0xcb, (byte) 0xe5, 0x72, (byte) 0xb9, 0x11 }, p.getData()));
		...
		assertEquals(true, p.isPrimitive());
		assertEquals(Tag.STRING_OCTET, p.getTag());
		assertTrue(Arrays.equals(new byte[] { (byte) 0xaa, (byte) 0x98, (byte) 0xac, (byte) 0xa6, 0x5a, (byte) 0xcd, 0x62, 0x36, 0x19, 0x0e, 0x37, (byte) 0xcb,
				(byte) 0xe5, 0x72, (byte) 0xb9, 0x11 }, p.getData()));
