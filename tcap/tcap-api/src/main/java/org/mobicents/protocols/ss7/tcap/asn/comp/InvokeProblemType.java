...
public enum InvokeProblemType {
	...
	/**
	 * The invoke ID is that of a previously invoked operation which has not been completed. 
	 * This code is generated by the TCAP layer now.
	 * If TC-user processes an incoming Invoke without answering with a result or error message
	 * it should invoke Dailog.processInvokeWithoutAnswer(Invoke invoke) method
	 */
	DuplicateInvokeID(0), 

	/**
	 * The operation code is not one of those agreed by the two TC-User.
	 * This code is generated by the TC-User (not by TCAP layer).
	 */
	...
	/**
	 * The requested operation cannot be invoked because the dialogue is about to be released.
	 * This code is generated by the TC-User (not by TCAP layer).
	 */
	InitiatingRelease(4), 

	/**
	 * The linked ID does not correspond to an active invoke operation.
	 * This code is generated by the TCAP layer.
	 */
	UnrechognizedLinkedID(5), 

	/**
	 * The operation referred to by the linked ID is not an operation
	 * for which linked invokes are allowed.
	 * This code is generated by the TC-User (not by TCAP layer).
	 */
