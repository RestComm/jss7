...
public interface CounterDef extends Serializable {
    ...
    /**
     * CounterName is a short abbreviation, some sort of counter Id. Avoid to keep spaces there CounterName (and CounterType)
     * must not be changed till the meaning of a counter has not changed CounterName must be changed when the meaning of a
     * counter has changed
     * 
     * @return
     */
