...
public class CallReferenceNumberImpl extends OctetStringBase implements CallReferenceNumber {
	 ...
	 */
	protected static final XMLFormat<CallReferenceNumberImpl> CALL_REFERENCE_NUMBER_XML = new XMLFormat<CallReferenceNumberImpl>(CallReferenceNumberImpl.class) {
