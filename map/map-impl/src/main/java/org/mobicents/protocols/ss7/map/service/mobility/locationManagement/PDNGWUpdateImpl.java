...
public class PDNGWUpdateImpl  extends SequenceBase implements PDNGWUpdate{
	...
	public PDNGWUpdateImpl(APN apn,
			PDNGWIdentity pdnGwIdentity, Integer contextId,
	...
	protected void _decode(AsnInputStream asnIS, int length)
		...
		while (true) {
			...
			case Tag.CLASS_CONTEXT_SPECIFIC: {
				...
				case _TAG_contextId:
					if (!ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ".contextId: Parameter is not primitive",
								MAPParsingComponentExceptionReason.MistypedParameter);
