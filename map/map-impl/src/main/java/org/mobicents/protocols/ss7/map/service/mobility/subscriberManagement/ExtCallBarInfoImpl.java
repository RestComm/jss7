 ...
 * 
 */
public class ExtCallBarInfoImpl implements ExtCallBarInfo, MAPAsnPrimitive {

	public static final String _PrimitiveName = "ExtCallBarInfo";
	...
	public void encodeData(AsnOutputStream asnOs) throws MAPException {
		...
		if (this.callBarringFeatureList.size() < 1 || this.callBarringFeatureList.size() > 32) {
			throw new MAPException("Error while encoding " + _PrimitiveName + ": Parameter callBarringFeatureList size must be from 1 to 32, found: "
