...
public abstract class USSDMessageImpl extends MessageImpl implements USSDMessage, MAPAsnPrimitive {
	 ...
	 */
	protected static final XMLFormat<USSDMessageImpl> USSD_MESSAGE_XML = new XMLFormat<USSDMessageImpl>(
			USSDMessageImpl.class) {

		@Override
		public void read(javolution.xml.XMLFormat.InputElement xml, USSDMessageImpl ussdMessage)
		...
		@Override
		public void write(USSDMessageImpl ussdMessage, javolution.xml.XMLFormat.OutputElement xml)
				throws XMLStreamException {
