 ...
 *
 */
public abstract class SubscriberInformationMessageImpl extends MessageImpl implements SubscriberInformationMessage, MAPAsnPrimitive {

	/**
	 * 
	 */
	public SubscriberInformationMessageImpl() {
		// TODO Auto-generated constructor stub
	}
	
	
	public MAPDialogSubscriberInformation getMAPDialog(){
		return (MAPDialogSubscriberInformation)super.getMAPDialog();
	}
