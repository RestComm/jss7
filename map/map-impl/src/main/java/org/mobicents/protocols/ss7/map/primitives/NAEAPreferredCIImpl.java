...
public class NAEAPreferredCIImpl extends SequenceBase implements NAEAPreferredCI{
	...
	public NAEAPreferredCIImpl(NAEACIC naeaPreferredCIC,
	...
	protected void _decode(AsnInputStream asnIS, int length)
			...
			case Tag.CLASS_CONTEXT_SPECIFIC: {
				...
				case _TAG_naeaPreferredCIC:
					if (!ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ".naeaPreferredCIC: Parameter is primitive",
		...
		if (this.naeaPreferredCIC == null)
			throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ": Parament naeaPreferredCIC is mandatory but does not found",
					MAPParsingComponentExceptionReason.MistypedParameter);
	}
