 ...
 * 
 */
public class AnyTimeInterrogationResponseIndicationImpl extends SubscriberInformationMessageImpl implements AnyTimeInterrogationResponseIndication,
		MAPAsnPrimitive {
	 ...
	 * 
	 */
	public AnyTimeInterrogationResponseIndicationImpl() {
	}
	 ...
	 */
	public AnyTimeInterrogationResponseIndicationImpl(SubscriberInfo subscriberInfo, MAPExtensionContainer extensionContainer) {
		super();
