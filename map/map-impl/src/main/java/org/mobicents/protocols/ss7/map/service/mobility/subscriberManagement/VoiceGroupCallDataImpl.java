...
public class VoiceGroupCallDataImpl  extends SequenceBase implements VoiceGroupCallData{
	...
	public VoiceGroupCallDataImpl( GroupId groupId,
	...
	protected void _decode(AsnInputStream asnIS, int length)
			...
			default:
				...
				case Tag.CLASS_UNIVERSAL: {					
					...
					case Tag.STRING_BIT:
						if (!ais.isTagPrimitive())
							throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
									+ ".additionalSubscriptions: Parameter is not primitive", MAPParsingComponentExceptionReason.MistypedParameter);
				...
				case Tag.CLASS_CONTEXT_SPECIFIC: {
					...
					case _TAG_additionalInfo:
						if (!ais.isTagPrimitive())
							throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ".additionalInfo: Parameter not primitive",
									MAPParsingComponentExceptionReason.MistypedParameter);
					...
					case _TAG_longGroupId:
						if (!ais.isTagPrimitive())
							throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ".longGroupId: Parameter not primitive",
									MAPParsingComponentExceptionReason.MistypedParameter);
		...
		if (this.groupId == null) {
			throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ": Parament groupId is mandatory but does not found",
					MAPParsingComponentExceptionReason.MistypedParameter);
		}
	}
