 ...
 *
 */
public class EUtranCgiImpl implements EUtranCgi, MAPAsnPrimitive {
	...
	public void decodeAll(AsnInputStream ansIS) throws MAPParsingComponentException {
		try {
			...
			throw new MAPParsingComponentException("IOException when decoding EUtranCgi: " + e.getMessage(), e,
					MAPParsingComponentExceptionReason.MistypedParameter);
		} catch (AsnException e) {
			throw new MAPParsingComponentException("AsnException when decoding EUtranCgi: " + e.getMessage(), e,
					MAPParsingComponentExceptionReason.MistypedParameter);
		}
	}
	...
	private void _decode(AsnInputStream asnIS, int length) throws MAPParsingComponentException, IOException, AsnException {
		...
		if (this.data.length != 7 )
			throw new MAPParsingComponentException("Error while decoding EUtranCgi value must be 7 bytes length, found: "
	...
	public void encodeAll(AsnOutputStream asnOs, int tagClass, int tag) throws MAPException {
		try {
			...
			throw new MAPException("AsnException when encoding EUtranCgi: " + e.getMessage(), e);
		}	
	}
	...
	public void encodeData(AsnOutputStream asnOs) throws MAPException {
		...
		if (this.data.length != 7)
			throw new MAPException("Data length must be 7");
		
		asnOs.writeOctetStringData(this.data);		
	}

	/* (non-Javadoc)
	 * @see org.mobicents.protocols.ss7.map.api.service.subscriberInformation.EUtranCgi#getData()
	 */
	public byte[] getData() {
		return this.data;
	}
