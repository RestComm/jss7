...
public class VlrCamelSubscriptionInfoImpl  extends SequenceBase implements VlrCamelSubscriptionInfo {
	...
	public VlrCamelSubscriptionInfoImpl(OCSI oCsi,
		...
		while (true) {
			...
			case Tag.CLASS_CONTEXT_SPECIFIC:
				...
				case _TAG_oBcsmCamelTDPCriteriaList:
					if (ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
								+ ".oBcsmCamelTDPCriteriaList: is primitive", MAPParsingComponentExceptionReason.MistypedParameter);
					...
					while (true) {
						...
						if (tag2 != Tag.SEQUENCE || ais2.getTagClass() != Tag.CLASS_UNIVERSAL || ais2.isTagPrimitive())
							throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
									+ ": bad OBcsmCamelTdpCriteria tag or tagClass or is primitive ", MAPParsingComponentExceptionReason.MistypedParameter);
					...
					if (this.oBcsmCamelTDPCriteriaList.size() < 1 || this.oBcsmCamelTDPCriteriaList.size() > 6) {
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ": Parameter oBcsmCamelTDPCriteriaList size must be from 1 to 4, found: "
				...
				case _TAG_tifCsi:
					if (!ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
								+ ".tifCsi: Parameter is not primitive ", MAPParsingComponentExceptionReason.MistypedParameter);
					ais.readNull();
					this.tifCsi = true;
					break;
				case _TAG_mCsi:
				...
				case _TAG_tBcsmCamelTdpCriteriaList:
					if (ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
								+ ".tBcsmCamelTdpCriteriaList: is primitive", MAPParsingComponentExceptionReason.MistypedParameter);
					...
					if (this.tBcsmCamelTdpCriteriaList.size() < 1 || this.tBcsmCamelTdpCriteriaList.size() > 6) {
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ": Parameter tBcsmCamelTdpCriteriaList from 1 to 4, found: "
				...
				case _TAG_mtSmsCamelTdpCriteriaList:
					if (ais.isTagPrimitive())
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
								+ ".mtSmsCamelTdpCriteriaList: is primitive", MAPParsingComponentExceptionReason.MistypedParameter);
					...
					if (this.mtSmsCamelTdpCriteriaList.size() < 1 || this.mtSmsCamelTdpCriteriaList.size() > 6) {
						throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName + ": Parameter mtSmsCamelTdpCriteriaList from 1 to 4, found: "
	...
	public void encodeData(AsnOutputStream asnOs) throws MAPException {
		...
		if (this.oBcsmCamelTDPCriteriaList != null && (this.oBcsmCamelTDPCriteriaList.size() < 1 || this.oBcsmCamelTDPCriteriaList.size() > 4)) {
			throw new MAPException("Error while encoding " + _PrimitiveName + ": Parameter oBcsmCamelTDPCriteriaList size must be from 1 to 4, found: "
