...
public class SMSCAMELTDPDataTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 56, -128, 1, 1, -127, 1, 4, -126, 4, -111, 34,
				50, -11, -125, 1, 0, -92, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4,
	...
	public void testEncode() throws Exception {
		...
		SMSCAMELTDPDataImpl prim = new SMSCAMELTDPDataImpl(smsTriggerDetectionPoint, serviceKey,
				gsmSCFAddress, defaultSMSHandling, extensionContainer);
