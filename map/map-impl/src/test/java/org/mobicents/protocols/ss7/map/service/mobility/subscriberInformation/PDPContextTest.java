...
public class PDPContextTest {
    ...
    private byte[] getEncodedData() {
        return new byte[] { 48, 102, 2, 1, 15, -112, 2, 11, 12, -111, 1, 21, -110, 3, 91, 92, 93, -109, 0, -108, 2, 22, 23,
                -75, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5,
                21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -128, 1, 15, -127, 2, 45, 46, -126, 1, 52, -125, 1, 55, -124, 1,
                91, -123, 9, 81, 92, 83, 84, 85, 86, 87, 88, 89, -122, 2, 58, 59, -121, 1, 60, -120, 1, 1, -119, 1, 1 };
    }
    ...
    public void testEncode() throws Exception {
        ...
        PDPContextImpl impl = new PDPContextImpl(15, pdpType, pdpAddress, qosSubscribed, true, apn,
                MAPExtensionContainerTest.GetTestExtensionContainer(), extQoSSubscribed, chargingCharacteristics,
                ext2QoSSubscribed, ext3QoSSubscribed, ext4QoSSubscribed, apnoiReplacement, extPdpType, extPdpAddress,
                SIPTOPermission.siptoNotAllowed, LIPAPermission.lipaOnly);
