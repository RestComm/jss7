...
public class TBcsmCamelTDPDataTest {
	...
	private byte[] getEncodedDataFull() {
		return new byte[] { 48, 57, 10, 1, 12, 2, 1, 3, -128, 5, -111, 17, 34, 51, -13, -127, 1, 1, -94, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14,
	...
	public void testEncode() throws Exception {
		...
		ISDNAddressStringImpl gsmSCFAddress = new ISDNAddressStringImpl(AddressNature.international_number, NumberingPlan.ISDN, "1122333");
		TBcsmCamelTDPDataImpl ind = new TBcsmCamelTDPDataImpl(TBcsmTriggerDetectionPoint.termAttemptAuthorized, 3, gsmSCFAddress,
		...
		ind = new TBcsmCamelTDPDataImpl(TBcsmTriggerDetectionPoint.termAttemptAuthorized, 3, gsmSCFAddress, DefaultCallHandling.releaseCall,
