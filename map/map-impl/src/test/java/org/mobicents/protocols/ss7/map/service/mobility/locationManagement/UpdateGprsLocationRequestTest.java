...
public class UpdateGprsLocationRequestTest {
	...
	public byte[] getData() {
		return new byte[] { 48, -127, -105, 4, 3, 17, 33, 34, 4, 4, -111, 34,
				34, -8, 4, 6, 23, 5, 38, 48, 81, 5, 48, 39, -96, 32, 48, 10, 6,
				3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11,
				6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33,
				-96, 43, 5, 0, -95, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11,
				12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5,
				21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -127, 0, -126, 0,
				-125, 6, 23, 5, 38, 48, 81, 5, -92, 6, -128, 4, 33, 67, 33, 67,
				-91, 4, -127, 2, 5, -32, -122, 0, -121, 0, -120, 1, 2, -119, 0,
				-118, 0, -117, 0, -116, 0, -115, 0, -114, 1, 1 };
	};
	...
	public void testEncode() throws Exception {
		...
		UpdateGprsLocationRequestImpl prim = new UpdateGprsLocationRequestImpl(imsi, sgsnNumber, sgsnAddress, extensionContainer, 
				sgsnCapability, informPreviousNetworkEntity, psLCSNotSupportedByUE, vGmlcAddress, addInfo, epsInfo, 
				servingNodeTypeIndicator, skipSubscriberDataUpdate, usedRATType, gprsSubscriptionDataNotNeeded, nodeTypeIndicator, 
				areaRestricted, ueReachableIndicator, epsSubscriptionDataNotNeeded, uesrvccCapability, 3);
