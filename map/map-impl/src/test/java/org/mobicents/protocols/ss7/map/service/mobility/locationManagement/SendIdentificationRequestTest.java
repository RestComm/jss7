...
public class SendIdentificationRequestTest {
	...
	public byte[] getData2() {
		return new byte[] { 48, 82, 4, 4, 1, 2, 3, 4, 2, 1, 2, 5, 0, 48, 39,
				-96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6,
				3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26,
				-95, 3, 31, 32, 33, 4, 4, -111, 34, 50, -12, -128, 5, 16, 97,
				66, 1, 77, -127, 1, 4, -126, 0, -125, 4, -111, 34, 50, -11,
				-124, 4, 1, 2, 3, 4 };
	};
	...
	public void testEncode() throws Exception {
		...
		prim = new SendIdentificationRequestImpl(tmsi, numberOfRequestedVectors, segmentationProhibited,
				extensionContainer, mscNumber, previousLAI, hopCounter, mtRoamingForwardingSupported,
				newVLRNumber, lmsi, 3);
