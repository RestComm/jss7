...
public class SendIdentificationResponseTest {
	...
	public byte[] getData1() {
		return new byte[] { 48, 48, 4, 8, 16, 33, 2, 2, 16, -119, 34, -9, 48,
				36, 48, 34, 4, 16, 15, -2, 18, -92, -49, 43, -35, -71, -78,
				-98, 109, 83, -76, -87, 77, -128, 4, 4, -32, 82, -17, -14, 4,
				8, 31, 72, -93, 97, 78, -17, -52, 0 };
	};

	public byte[] getData2() {
		return new byte[] { -93, 106, 4, 8, 16, 33, 2, 2, 16, -119, 34, -9,
				-96, 36, 48, 34, 4, 16, 15, -2, 18, -92, -49, 43, -35, -71,
				-78, -98, 109, 83, -76, -87, 77, -128, 4, 4, -32, 82, -17, -14,
				4, 8, 31, 72, -93, 97, 78, -17, -52, 0, -94, 15, -96, 13, 4, 8,
				31, 72, -93, 97, 78, -17, -52, 0, 4, 1, 4, -93, 39, -96, 32,
	...
	public void testEncode() throws Exception {
		...
		AuthenticationTripletImpl at = new AuthenticationTripletImpl(SendIdentificationResponseTest.getRandData(), SendIdentificationResponseTest.getSresData(),
				SendIdentificationResponseTest.getKcData());
		ats.add(at);
		...
		at = new AuthenticationTripletImpl(SendIdentificationResponseTest.getRandData(), SendIdentificationResponseTest.getSresData(),
				SendIdentificationResponseTest.getKcData());
		ats.add(at);
		...
		prim = new SendIdentificationResponseImpl(imsi, authenticationSetList,
				currentSecurityContext, extensionContainer, 3);
