...
public class InsertSubscriberDataResponseTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 81, -95, 3, 4, 1, 16, -94, 3, 4, 1, 22, -93, 3, 4, 1, 0, -124, 5, 3, 74, -43, 85, 80, -123, 1, 1, -122, 2, 4, -16, -89, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -120, 2, 1, -2, -119, 5, 6, 85, 85, 85, 64 };
	};
	
	public byte[] getData1() {
		return new byte[] { 48, 25, -95, 3, 4, 1, 16, -94, 3, 4, 1, 22, -93, 3, 4, 1, 0, -124, 5, 3, 74, -43, 85, 80, -123, 1, 1 };
	};
	...
	public void testEncode() throws Exception {
		...
		SupportedFeatures supportedFeatures = new SupportedFeaturesImpl(false, true, false, true,
				false, true, false, true, false, true, false, true, false, true, false,
				true, false, true, false, true, false, true, false, true, false, true);
		
		InsertSubscriberDataResponseImpl prim = new InsertSubscriberDataResponseImpl(3, teleserviceList, 
				bearerServiceList, ssList, odbGeneralData, regionalSubscriptionResponse, supportedCamelPhases, 
