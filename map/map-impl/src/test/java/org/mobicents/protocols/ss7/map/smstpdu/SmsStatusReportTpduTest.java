...
public class SmsStatusReportTpduTest {
	...
	public byte[] getData1() {
		return new byte[] { 6, 26, 13, -111, 17, 34, 51, 68, 85, 102, -9, -112, 48, 66, 97, 65, 35, 33, -112, 48, 66, 97, 65, 35, 33, 0 };
	}

	public byte[] getDataFull() {
		return new byte[] { 34, -1, 7, -111, 119, 102, 85, -16, -112, 48, 66, 97, 65, 35, 0, -112, 48, 66, 97, 65, 35, 76, 10, 7, 0, 0, 4, -63, -80, -48, 14 };
	}
	...
	public void testDecode() throws Exception {
		...
		assertEquals(impl.getRecipientAddress().getNumberingPlanIdentification(), NumberingPlanIdentification.ISDNTelephoneNumberingPlan);
	...
	public void testEncode() throws Exception {
		...
		AddressFieldImpl recipientAddress = new AddressFieldImpl(TypeOfNumber.InternationalNumber, NumberingPlanIdentification.ISDNTelephoneNumberingPlan,
				"1122334455667");
		...
		SmsStatusReportTpduImpl impl = new SmsStatusReportTpduImpl(false, false, StatusReportQualifier.SmsSubmitResult, 26, recipientAddress,
				serviceCentreTimeStamp, dischargeTime, status, null, null);
		...
		recipientAddress = new AddressFieldImpl(TypeOfNumber.InternationalNumber, NumberingPlanIdentification.ISDNTelephoneNumberingPlan,
				"7766550");
