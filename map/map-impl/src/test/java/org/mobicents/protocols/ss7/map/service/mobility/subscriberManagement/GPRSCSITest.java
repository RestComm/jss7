...
public class GPRSCSITest {
	...
	public byte[] getData() {
		return new byte[] { 48, 108, -96, 58, 48, 56, -128, 1, 2, -127, 1, 2,
				-126, 4, -111, 34, 34, -8, -125, 1, 1, -92, 39, -96, 32, 48,
	...
	public void testEncode() throws Exception {
		...
		GPRSCSIImpl prim = new GPRSCSIImpl(gprsCamelTDPDataList, camelCapabilityHandling,
