...
public class GPRSCamelTDPDataTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 56, -128, 1, 2, -127, 1, 2, -126, 4, -111, 34,
				34, -8, -125, 1, 1, -92, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4,
				11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3,
				5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33 };
	};
	...
	public void testEncode() throws Exception {
		...
		GPRSCamelTDPDataImpl prim = new GPRSCamelTDPDataImpl(gprsTriggerDetectionPoint, serviceKey, 
