...
public class GPRSSubscriptionDataTest {
	...
	public byte[] getData() {
		return new byte[] { 48, -127, -88, -95, 114, 48, 112, 2, 1, 1, -112, 2,
				5, 3, -111, 3, 5, 6, 7, -110, 3, 4, 7, 7, -108, 2, 6, 7, -75,
				39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5,
				6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26,
				-95, 3, 31, 32, 33, -128, 2, 1, 7, -127, 2, 6, 5, -126, 2, 1,
				8, -125, 2, 2, 6, -124, 1, 2, -123, 9, 48, 12, 17, 17, 119, 22,
				62, 34, 12, -122, 2, 6, 5, -121, 3, 4, 6, 5, -111, 3, 5, 6, 7,
				-120, 1, 0, -119, 1, 2, -94, 39, -96, 32, 48, 10, 6, 3, 42, 3,
				4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42,
				3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -125, 9, 48,
				12, 17, 17, 119, 22, 62, 34, 12 };
	};
	...
	public void testEncode() throws Exception {
		...
		APNOIReplacement apnOiReplacement = new APNOIReplacementImpl(this.getAPNOIReplacementData());
		GPRSSubscriptionDataImpl prim = new GPRSSubscriptionDataImpl(false,
