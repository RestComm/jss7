...
public class LSAInformationTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 101, 5, 0, -127, 1, 1, -94, 53, 48, 51, -128,
				3, 12, 34, 26, -127, 1, 5, -126, 0, -93, 39, -96, 32, 48, 10,
				6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48,
				11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33,
				-93, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15,
	...
	public void testEncode() throws Exception {
		...
		LSAInformationImpl prim = new LSAInformationImpl(completeDataListIncluded, lsaOnlyAccessIndicator, lsaDataList, extensionContainer);
