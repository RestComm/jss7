...
public class CBSDataCodingSchemeTest {
	...
	public void testEncode() throws Exception {
		...
		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.GeneralDataCodingIndication, CharacterSet.UCS2, null, DataCodingSchemaMessageClass.Class0, true);
		assertEquals(dcs.getCode(), 0x78);

		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.GeneralDataCodingIndication, CharacterSet.GSM8, null, DataCodingSchemaMessageClass.Class3, false);
		assertEquals(dcs.getCode(), 0x57);

		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.GeneralDataCodingIndication, CharacterSet.Reserved, null, null, false);
		assertEquals(dcs.getCode(), 0x4C);

		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.MessageWithUserDataHeader, CharacterSet.UCS2, null, DataCodingSchemaMessageClass.Class1, false);
		...
		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.DataCodingMessageClass, CharacterSet.GSM8, null, DataCodingSchemaMessageClass.Class2, false);
		assertEquals(dcs.getCode(), 0xF6);

		dcs = new CBSDataCodingSchemeImpl(CBSDataCodingGroup.DataCodingMessageClass, CharacterSet.GSM7, null, DataCodingSchemaMessageClass.Class3, false);
