 ...
 * 
 */
public class AnyTimeInterrogationRequestIndicationTest {
	// Real Trace
	...
	public void testDecode() throws Exception {
		...
		AnyTimeInterrogationRequestIndicationImpl anyTimeInt = new AnyTimeInterrogationRequestIndicationImpl();
	...
	public void testEncode() throws Exception {
		...
		AnyTimeInterrogationRequestIndicationImpl anyTimeInt = new AnyTimeInterrogationRequestIndicationImpl(subsId, requestedInfo, gscmSCFAddress, null);
		anyTimeInt.decodeAll(ansIS);
