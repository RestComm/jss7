...
public class SmsSubmitTpduTest {
	...
	public byte[] getData1() {
		return new byte[] { 81, 83, 11, -111, -103, -119, -120, 119, 7, -16, 0, 0, -83, 41, 5, 0, 3, -17, 2, 1, -112, 101, 54, -5, 13, 10, -123, 66, 33, 80,
				44, 22, 3, -55, 100, 50, -48, 108, 54, 3, -47, 104, 52, 80, -83, 86, 3, -39, 108, 54 };
	}
	...
	public byte[] getData2() {
		return new byte[] { -99, -31, 15, -111, 17, 17, 17, 17, 33, 34, 0, -16, 1, 8, 17, 16, 3, 32, 3, -123, 72, 102, 0, 65, 0, 100, 0, 100, 0, 114, 0, 101,
				0, 115, 0, 115, 0, 70, 0, 105, 0, 101, 0, 108, 0, 100, 0, 73, 0, 109, 0, 112, 0, 108, 0, 32, 0, 100, 0, 101, 0, 115, 0, 116, 0, 65, 0, 100, 0,
				100, 0, 114, 0, 101, 0, 115, 0, 115, 0, 32, 0, 61, 0, 32, 0, 110, 0, 101, 0, 119, 0, 32, 0, 65, 0, 100, 0, 100, 0, 114, 0, 101, 0, 115, 0, 115,
				0, 70, 0, 105, 0, 101, 0, 108, 0, 100, 0, 73, 0, 109, 0, 112, 0, 108 };
	}

	public byte[] getData3() {
		return new byte[] { -87, 0, 3, -29, 0, -16, 2, 4, 1, 2, 3, 4, 5, 6, 7, 51, 65, 100, 100, 114, 101, 115, 115, 70, 105, 101, 108, 100, 73, 109, 112, 108,
				32, 100, 101, 115, 116, 65, 100, 100, 114, 101, 115, 115, 32, 61, 32, 110, 101, 119, 32, 65, 100, 100, 114, 101, 115, 115, 70, 105, 101, 108,
				100, 73, 109, 112, 108 };
	}
	...
	public void testDecode() throws Exception {
		...
		assertEquals(impl.getDestinationAddress().getNumberingPlanIdentification(), NumberingPlanIdentification.DataNumberingPlan);
...
//		SortedMap<String,Charset> rr = Charset.availableCharsets();
		...
		UserDataImpl ud = new UserDataImpl(
				"Hello !!!! 111 222 333 444 555 666",
				new DataCodingSchemeImpl(0), udh, null);
		AddressFieldImpl destAddress = new AddressFieldImpl(TypeOfNumber.InternationalNumber, NumberingPlanIdentification.ISDNTelephoneNumberingPlan,
				"99988877700");
		...
		ud = new UserDataImpl(
				"AddressFieldImpl destAddress = new AddressFieldImpl",
				new DataCodingSchemeImpl(8), null, null);
		destAddress = new AddressFieldImpl(TypeOfNumber.InternationalNumber, NumberingPlanIdentification.ISDNTelephoneNumberingPlan,
				"111111111222000");
		...
		ud = new UserDataImpl(
				"AddressFieldImpl destAddress = new AddressFieldImpl",
				new DataCodingSchemeImpl(4), null, Charset.forName("US-ASCII"));
		destAddress = new AddressFieldImpl(TypeOfNumber.AbbreviatedNumber, NumberingPlanIdentification.DataNumberingPlan,
				"000");
