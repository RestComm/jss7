...
public class LCSPrivacyClassTest {
	...
	public void testEncode() throws Exception {
		...
		LCSPrivacyClassImpl prim = new LCSPrivacyClassImpl(ssCode, ssStatus, notificationToMSUser, externalClientList, plmnClientList, extensionContainer, extExternalClientList, serviceTypeList);
