...
public class ExtForwFeatureTest {
	public byte[] getData() {
		return new byte[] { 48, 69, -126, 1, 22, -124, 1, 3, -123, 4, -111, 34,
				34, -8, -120, 2, 2, 5, -122, 1, -92, -121, 1, 2, -87, 39, -96,
	...
	public byte[] getData2() {
		return new byte[] { 48, 17, (byte) 131, 1, 16, (byte) 132, 1, 15, (byte) 133, 6, (byte) 145, (byte) 153, (byte) 137, (byte) 136, 119, (byte) 247,
				(byte) 134, 1, 0 };
	};
	...
	public void testDecode() throws Exception {
		...
		assertEquals(prim.getBasicService().getExtTeleservice().getTeleserviceCodeValue(), TeleserviceCodeValue.allSpeechTransmissionServices);
		...
		assertEquals(prim.getForwardingOptions().getExtForwOptionsForwardingReason(), ExtForwOptionsForwardingReason.msNotReachable);
	...
	public void testEncode() throws Exception {
		...
		ExtForwFeatureImpl prim = new ExtForwFeatureImpl(basicService, ssStatus,
