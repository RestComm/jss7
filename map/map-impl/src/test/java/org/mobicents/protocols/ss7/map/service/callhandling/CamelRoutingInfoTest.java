...
public class CamelRoutingInfoTest {
	...
	private byte[] getEncodedData() {
		return new byte[] { -88, 64, 48, 7, -123, 5, -111, 17, 17, 33, 34, -96, 12, -96, 10, 48, 8, 48, 6, 10, 1, 12, 2, 1, 5, -95, 39, -96, 32, 48, 10, 6, 3,
	...
	public void testDecode() throws Exception {
		...
		assertEquals(gcs.getTCsi().getTBcsmCamelTDPDataList().get(0).getTBcsmTriggerDetectionPoint(), TBcsmTriggerDetectionPoint.termAttemptAuthorized);
	...
	public void testEncode() throws Exception {
		...
		// ForwardingData forwardingData, GmscCamelSubscriptionInfo gmscCamelSubscriptionInfo, MAPExtensionContainer extensionContainer
