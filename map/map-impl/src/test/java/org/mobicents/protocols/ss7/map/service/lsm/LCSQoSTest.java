...
public class LCSQoSTest {
	...
	public byte[] getDataFull() {
		return new byte[] { 48, 54, -128, 1, 10, -127, 0, -126, 1, 20, -93, 3, 10, 1, 0, -92, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5,
	...
	public void testEncode() throws Exception {
		...
		lcsQos = new LCSQoSImpl(10, 20, true, new ResponseTimeImpl(ResponseTimeCategory.lowdelay), MAPExtensionContainerTest.GetTestExtensionContainer());
