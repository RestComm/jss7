 ...
 * 
 */
public class AnyTimeInterrogationResponseIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		AnyTimeInterrogationResponseIndicationImpl atiResponse = new AnyTimeInterrogationResponseIndicationImpl();
