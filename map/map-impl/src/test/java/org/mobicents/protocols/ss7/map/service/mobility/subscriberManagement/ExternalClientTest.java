...
public class ExternalClientTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 96, 48, 47, -128, 4, -111, 34, 34, -8, -95, 39,
	...
	public void testEncode() throws Exception {
		...
		ExternalClientImpl prim = new ExternalClientImpl(clientIdentity, gmlcRestriction, notificationToMSUser, extensionContainer);
