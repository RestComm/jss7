...
public class ServiceTypeTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 50, 2, 1, 1, -128, 1, 0, -127, 1, 1, -94, 39,
	...
	public void testEncode() throws Exception {
		...
		ServiceTypeImpl prim = new ServiceTypeImpl(serviceTypeIdentity, gmlcRestriction, notificationToMSUser, extensionContainer);
