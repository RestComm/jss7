...
public class CUGFeatureTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 50, -126, 1, 22, 2, 1, 1, 4, 1, 0, 48, 39, -96,
	...
	public byte[] getData1() {
		return new byte[] { 48, 50, -125, 1, 17, 2, 1, 1, 4, 1, 0, 48, 39, -96,
				32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3,
				42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95,
				3, 31, 32, 33 };
	};
...
//			MAPExtensionContainer extensionContainer = getMapExtensionContainer();
			...
			CUGFeatureImpl prim = new CUGFeatureImpl(basicService, preferentialCugIndicator, 
