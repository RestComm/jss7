...
public class MGCSITest {
	...
	public byte[] getData() {
		return new byte[] { 48, 62, 48, 6, 4, 1, -125, 4, 1, 2, 2, 1, 3, -128,
				4, -111, 34, 50, -11, -95, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4,
				11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3,
				5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -126, 0, -125, 0 };
	};
	...
	public void testEncode() throws Exception {
		...
		MGCSIImpl prim = new MGCSIImpl(mobilityTriggers, 3, gsmSCFAddress, extensionContainer,
				true, true);
