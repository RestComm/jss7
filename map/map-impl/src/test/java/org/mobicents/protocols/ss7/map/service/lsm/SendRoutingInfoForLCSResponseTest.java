...
public class SendRoutingInfoForLCSResponseTest {
	...
	public byte[] getEncodedData() {
		...
		return new byte[] { 0x30, 0x14, (byte) 0xa0, 0x09, (byte) 0x81, 0x07, (byte) 0x91, 0x55, 0x16, 0x28, (byte) 0x81, 0x00, 0x70, (byte) 0xa1, 0x07, 0x04,
				0x05, (byte) 0x91, 0x55, 0x16, 0x09, 0x00 };
	}

	public byte[] getEncodedDataFull() {
		return new byte[] { 48, 89, -96, 9, -127, 7, -111, 85, 22, 40, -127, 0, 112, -95, 7, 4, 5, -111, 85, 22, 9, 0, -94, 39, -96, 32, 48, 10, 6, 3, 42, 3,
				4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -125, 5, 11, 12, 13, 14, 15,
				-124, 5, 21, 22, 23, 24, 25, -123, 5, 31, 32, 33, 34, 35, -122, 5, 41, 42, 43, 44, 45 };
	}
	...
	public void testEncode() throws Exception {
		...
		ISDNAddressString msisdn = this.MAPParameterFactory.createISDNAddressString(AddressNature.international_number, NumberingPlan.ISDN, "556182180007");
		...
		SendRoutingInfoForLCSResponseImpl impl = new SendRoutingInfoForLCSResponseImpl(subsIdent, lcsLocInfo, null, null,
				null, null, null);
		...
		impl = new SendRoutingInfoForLCSResponseImpl(subsIdent, lcsLocInfo, MAPExtensionContainerTest.GetTestExtensionContainer(), vgmlcAddress, hGmlcAddress,
