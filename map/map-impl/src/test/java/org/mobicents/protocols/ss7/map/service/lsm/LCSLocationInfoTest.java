...
public class LCSLocationInfoTest {
	...
	public byte[] getEncodedData() {
		return new byte[] { 48, 96, 4, 5, -111, 85, 22, 9, 112, -128, 4, 11, 12, 13, 14, -95, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5,
				6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -126, 0, -93, 8, -128, 6, -111, 34, 34, 17, 34, 34, -124,
				2, 3, -64, -123, 2, 3, -32, -122, 9, 21, 22, 23, 23, 25, 26, 27, 28, 29, -120, 9, 31, 32, 33, 33, 35, 36, 37, 38, 39 };
	}
	...
	public void testEncode() throws Exception {
		...
		ISDNAddressString networkNodeNumber = MAPParameterFactory.createISDNAddressString(AddressNature.international_number, NumberingPlan.ISDN, "55619007");
		LMSIImpl lmsi = new LMSIImpl(getDataLmsi());
		ISDNAddressString mscNumber = MAPParameterFactory.createISDNAddressString(AddressNature.international_number, NumberingPlan.ISDN, "2222112222");
		AdditionalNumberImpl additionalNumber = new AdditionalNumberImpl(mscNumber, null);
		SupportedLCSCapabilitySetsImpl supportedLCSCapabilitySets = new SupportedLCSCapabilitySetsImpl(true, true, false, false, false);
		SupportedLCSCapabilitySetsImpl additionalLCSCapabilitySets = new SupportedLCSCapabilitySetsImpl(true, true, true, false, false);
		...
		LCSLocationInfoImpl imp = new LCSLocationInfoImpl(networkNodeNumber, lmsi, MAPExtensionContainerTest.GetTestExtensionContainer(), true,
