...
public class UpdateGprsLocationResponseTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 51, 4, 4, -111, 34, 34, -8, 48, 39, -96, 32,
	...
	public void testEncode() throws Exception {
		...
		UpdateGprsLocationResponseImpl prim = new UpdateGprsLocationResponseImpl(hlrNumber, extensionContainer, true,
				true);
