...
public class CancelLocationRequestTest {
	...
	public void testEncode() throws Exception {
		...
		CancelLocationRequestImpl asc = new CancelLocationRequestImpl(imsi, null, cancellationType, extensionContainer, typeOfUpdate, mtrfSupportedAndAuthorized, mtrfSupportedAndNotAuthorized, newMSCNumber, newVLRNumber, newLmsi, mapProtocolVersion);
