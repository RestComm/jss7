...
public class SendRoutingInformationResponseTest {
	...
	public void testDecode() throws Exception {
		byte[] data = new byte[] { 48, 19, (byte) 137, 8, 16, 33, 2, 2, 16, -119, 34, -9, 4, 7, -111, -105, 114, 99, 80, 24, -7 };
		byte[] data_ = new byte[] { 48, 24, (byte) 137, 8, 16, 33, 2, 2, 16, -119, 34, -9, 48, 12, (byte) 133, 7, -111, -105, 114, 99, 80, 24, -7, (byte) 134, 1, 36 };
	...
	public void testEncode() throws Exception {
		...
		RoutingInfoImpl routingInfo = new RoutingInfoImpl(roamingNumber, null);
		ExtendedRoutingInfoImpl extRoutingInfo = new ExtendedRoutingInfoImpl(routingInfo, null);
		...
		RoutingInfoImpl routingInfo_ = new RoutingInfoImpl(null, forwardingData_);
		ExtendedRoutingInfoImpl extRoutingInfo_ = new ExtendedRoutingInfoImpl(routingInfo_, null);
