...
public class SendRoutingInformationResponseTest {
	...
	private byte[] getMAPV3ParameterTestData() {
		return new byte[] { -93, -126, 1, 94, -119, 8, 16, 33, 2, 2, 16, -119,
				34, -9, 48, 12, -123, 7, -111, -105, 114, 99, 80, 24, -7, -122,
				1, 36, -93, 49, 4, 4, 1, 2, 3, 4, 5, 0, 48, 39, -96, 32, 48,
				10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6,
				48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32,
				33, -122, 0, -89, 50, -96, 44, 2, 1, 1, -128, 8, 16, 0, 0, 0,
				0, 0, 0, 0, -127, 7, -111, -105, 114, 99, 80, 24, -7, -93, 9,
				-128, 7, 39, -12, 67, 121, -98, 41, -96, -122, 7, -111, -105,
				114, 99, 80, 24, -7, -119, 0, -95, 2, -128, 0, -95, 3, 4, 1,
				96, -91, 3, -126, 1, 22, -124, 0, -126, 7, -111, -105, 114, 99,
				80, 24, -7, -96, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12,
				13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21,
				22, 23, 24, 25, 26, -95, 3, 31, 32, 33, -86, 46, -128, 3, 15,
				48, 5, -95, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13,
				14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22,
				23, 24, 25, 26, -95, 3, 31, 32, 33, -85, 45, -128, 0, -127, 0,
				-94, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15,
				48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24,
				25, 26, -95, 3, 31, 32, 33, -116, 7, -111, -105, 114, 99, 80,
				24, -7, -115, 1, 5, -114, 1, 5, -113, 2, 4, -32, -112, 2, 1,
				-2, -79, 9, 4, 7, -111, -105, 114, 99, 80, 24, -7, -78, 3, 4,
				1, 96, -77, 3, -126, 1, 22, -108, 2, 6, -64, -107, 1, 4, -106,
				0, -73, 9, 10, 1, 2, 4, 4, 10, 20, 30, 40 };
	}
	
	private byte[] getMAPV3ParameterTestData2() {
		return new byte[] { 48, 70, 4, 8, 16, 33, 2, 2, 16, -119, 34, -9, 4, 7,
				-111, -105, 114, 99, 80, 24, -7, 48, 49, 4, 4, 1, 2, 3, 4, 5,
				0, 48, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15,
				48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24,
				25, 26, -95, 3, 31, 32, 33 };
	}
	...
	public void testDecode() throws Exception {
		...
		assertEquals(prim.getSSList().get(0).getSupplementaryCodeValue(),SupplementaryCodeValue.allFacsimileTransmissionServices);
...
//		/getRoutingInfo2
		...
		assertEquals(prim.getSSList2().get(0).getSupplementaryCodeValue(),SupplementaryCodeValue.allFacsimileTransmissionServices);
		//basicService2
...
//		/getRoutingInfo2
	...
	public void testEncode() throws Exception {
		...
		CUGCheckInfo cugCheckInfo = new CUGCheckInfoImpl(cugInterlock, true, MAPExtensionContainerTest.GetTestExtensionContainer());
		//cugSubscriptionFlag
		boolean cugSubscriptionFlag = true;
		//subscriberInfo
		ISDNAddressStringImpl vlrN = new ISDNAddressStringImpl(AddressNature.international_number, NumberingPlan.ISDN, "79273605819");
		ISDNAddressStringImpl mscN = new ISDNAddressStringImpl(AddressNature.international_number, NumberingPlan.ISDN, "79273605819");
		...
		LocationInformationImpl li = new LocationInformationImpl(1, gi, vlrN, null, c, null, null, mscN, null, false, true, null, null);
		...
		NAEAPreferredCIImpl naeaPreferredCI = new NAEAPreferredCIImpl(naeaPreferredCIC,  MAPExtensionContainerTest.GetTestExtensionContainer());
		//ccbsIndicators
		CCBSIndicatorsImpl ccbsIndicators = new CCBSIndicatorsImpl(true, true,  MAPExtensionContainerTest.GetTestExtensionContainer());
		//msisdn
		...
		SendRoutingInformationResponseImpl prim = new SendRoutingInformationResponseImpl(mapProtocolVersion, imsi_,
				...
				forwardingInterrogationRequired, vmscAddress, extensionContainer, naeaPreferredCI, ccbsIndicators,
				msisdn, nrPortabilityStatus, istAlertTimer, supportedCamelPhases, offeredCamel4CSIs, routingInfo2,
				ssList2, basicService2, allowedServices, unavailabilityCause, releaseResourcesSupported, gsmBearerCapability);
		...
		prim = new SendRoutingInformationResponseImpl(mapProtocolVersion, imsi_,
				extRoutingInfo_, cugCheckInfo, cugSubscriptionFlag, subscriberInfo, ssList, basicService,
				forwardingInterrogationRequired, vmscAddress, extensionContainer, naeaPreferredCI, ccbsIndicators,
				msisdn, nrPortabilityStatus, istAlertTimer, supportedCamelPhases, offeredCamel4CSIs, routingInfo2,
				ssList2, basicService2, allowedServices, unavailabilityCause, releaseResourcesSupported, gsmBearerCapability);
