...
public class ExtSSInfoTest {
	...
	public byte[] getData() {
		return new byte[] { -96, 117, 4, 1, 0, 48, 71, 48, 69, -126, 1, 22,
	...
	public byte[] getData1() {
		return new byte[] { -95, 95, 4, 1, 0, 48, 49, 48, 47, -126, 1, 22,
				-124, 1, 3, 48, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11, 12,
				13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21,
				22, 23, 24, 25, 26, -95, 3, 31, 32, 33, 48, 39, -96, 32, 48,
	...
	public byte[] getData2() {
		return new byte[] { -94, -127, -99, 48, 60, 48, 58, 2, 1, 1, 4, 4, 1,
				2, 3, 4, 10, 1, 0, 48, 3, -126, 1, 22, -96, 39, -96, 32, 48,
				10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6,
				48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95, 3, 31, 32,
				33, 48, 52, 48, 50, -126, 1, 22, 2, 1, 1, 4, 1, 0, 48, 39, -96,
				32, 48, 10, 6, 3, 42, 3, 4, 11, 12, 13, 14, 15, 48, 5, 6, 3,
				42, 3, 6, 48, 11, 6, 3, 42, 3, 5, 21, 22, 23, 24, 25, 26, -95,
				3, 31, 32, 33, -96, 39, -96, 32, 48, 10, 6, 3, 42, 3, 4, 11,
				12, 13, 14, 15, 48, 5, 6, 3, 42, 3, 6, 48, 11, 6, 3, 42, 3, 5,
				21, 22, 23, 24, 25, 26, -95, 3, 31, 32, 33 };
	};
	
	public byte[] getData3() {
		return new byte[] { -93, 55, 4, 1, 0, -124, 1, 3, -126, 1, 0, 48, 3,
	...
	public byte[] getData4() {
		return new byte[] { -92, 47, 2, 1, 2, 2, 1, 1, 48, 39, -96, 32, 48, 10,
	...
	public void testDecode() throws Exception {
		...
		assertTrue(forwardingInfo.getSsCode().getData() == SupplementaryCodeValue.allServices.getCode());
		...
		assertTrue(Arrays.equals(extForwFeature.getBasicService().getExtBearerService().getData(), 
		...
		assertTrue(callBarringInfo.getSsCode().getData() == SupplementaryCodeValue.allServices.getCode());
		assertNotNull(callBarringInfo.getCallBarringFeatureList());
		assertTrue(callBarringInfo.getCallBarringFeatureList().size() == 1);
		...
		assertTrue(cugInfo.getCUGSubscriptionList().size()==1);
		assertNotNull(cugInfo.getCUGSubscriptionList().get(0));
		assertNotNull(cugInfo.getCUGFeatureList());
		assertTrue(cugInfo.getCUGFeatureList().size()==1);
		...
		assertTrue(ssData.getSsCode().getData() == SupplementaryCodeValue.allServices.getCode());
		...
		assertTrue(ssData.getSSSubscriptionOption().getCliRestrictionOption().getCode() == CliRestrictionOption.permanent.getCode() );
		...
		assertTrue(emlppInfo.getMaximumentitledPriority() == 2);
		assertTrue(emlppInfo.getDefaultPriority() == 1);
		assertNotNull(extensionContainer);
	}
	...
	public void testEncode() throws Exception {
		...
		ExtSSData ssData = new ExtSSDataImpl(ssCode, ssStatus, ssSubscriptionOption,
