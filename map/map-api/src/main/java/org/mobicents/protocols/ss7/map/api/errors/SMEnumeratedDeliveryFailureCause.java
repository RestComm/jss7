...
public enum SMEnumeratedDeliveryFailureCause {
	memoryCapacityExceeded(0), equipmentProtocolError(1), equipmentNotSMEquipped(2), 
	unknownServiceCentre(3), scCongestion(4), invalidSMEAddress(5), subscriberNotSCSubscriber(6);
