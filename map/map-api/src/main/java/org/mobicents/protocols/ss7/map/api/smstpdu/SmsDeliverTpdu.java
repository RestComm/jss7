...
public interface SmsDeliverTpdu extends SmsTpdu {
	...
	/**
	 * Mandatory. Parameter indicating whether or not there are more messages to
	 * send.
	 * 
	 * @return TP-MMS field
	 */
	...
	/**
	 * @return TP-LP field false: The message has not been forwarded and is not
	 *         a spawned message (or the sending network entity (e.g. an SC)
	 *         does not support the setting of this bit.) true: The message has
	 *         either been forwarded or is a spawned message.
	 */
	...
	/**
	 * Optional. Parameter indicating whether the SME has requested a status
	 * report.
	 * 
	 * @return TP-SRI field
	 */
