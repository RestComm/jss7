...
/**
 * Provider reason: This parameter indicates the reason for aborting the MAP
 * dialogue: - provider malfunction; - supporting dialogue/transaction released;
 * - resource limitation; - maintenance activity; - version incompatibility; -
