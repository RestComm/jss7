...
package org.mobicents.ss7.sccp.impl.intel;
...
import org.mobicents.ss7.sccp.impl.Handler;
import org.mobicents.ss7.sccp.impl.SccpProviderImpl;
import org.mobicents.ss7.sccp.impl.intel.gt.InterProcessCommunicator;
...
import org.mobicents.ss7.utils.Utils;
...
public class SccpIntelHDCProviderImpl extends SccpProviderImpl implements Runnable, SccpProvider {
    ...
    public synchronized void send(SccpAddress calledParty,
        ...
        UnitDataImpl unitData = new UnitDataImpl(
                new ProtocolClassImpl(0,0), calledParty, callingParty, data);
        unitData.encode(out);
