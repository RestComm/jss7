...
public class ConnectionCouplingTest extends SccpHarness3 {
    ...
    public void testTransit() throws Exception {
        ...
        User u2 = new User(sccpStack2.getSccpProvider(), a2, null, getSSN()); //TODO2 no need for listener at relay or maybe it's needed? ***
    ...
    @Test(groups = { "SccpMessage", "functional.connection" })
    public void testTransitReset() throws Exception { //TODO2 cleanup separators
        sccpStack1.connEstTimerDelay = 1000000000;
        sccpStack2.connEstTimerDelay = 1000000000;
        sccpStack3.connEstTimerDelay = 1000000000;
