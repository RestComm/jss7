...
public class Mtp3PrimitiveMessage {
	...
	public String toString() {
		return "Mtp3PrimitiveMessage [seq=" + seq + ", type=" + type + ", affectedPc=" + affectedPc + ", unavailabiltyCause=" + unavailabiltyCause
				+ ", status=" + status + ", congestion=" + congestion + ", tstamp=" + tstamp + "]";
	}
