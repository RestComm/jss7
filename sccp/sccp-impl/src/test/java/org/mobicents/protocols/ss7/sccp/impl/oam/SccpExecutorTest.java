...
public class SccpExecutorTest {
	...
	public void testManageRule() {
		...
		assertEquals(
				result,
				"key=1  Rule=ruleType(Solitary);patternSccpAddress(pc=2,ssn=8,AI=71,gt=GT0001{na=NATIONAL, digits=123456789});paddress(1);saddress(-1);mask(R)\n");
		...
		assertEquals(pattern.getAddressIndicator().getRoutingIndicator(),
	...
	/**
	 * Test for bug http://code.google.com/p/mobicents/issues/detail?id=3057 NPE
	 * when creating SCCP primary address via CLI
	 */
	@Test(groups = { "oam", "functional.mgmt" })
	...
	class Mtp3UserPartImpl implements Mtp3UserPart {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.mobicents.protocols.ss7.mtp.Mtp3UserPart#
		 ...
		 * 
		 * @see
		 * org.mobicents.protocols.ss7.mtp.Mtp3UserPart#getRoutingLabelFormat()
		 */
		@Override
		 ...
		 * 
		 * @see
		 * org.mobicents.protocols.ss7.mtp.Mtp3UserPart#setRoutingLabelFormat
