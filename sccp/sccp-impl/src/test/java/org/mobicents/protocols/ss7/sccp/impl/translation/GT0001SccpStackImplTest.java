...
public class GT0001SccpStackImplTest extends SccpHarness {
    ...
    public void testRemoteRoutingBasedOnGT_DPC_SSN() throws Exception {
        ...
        SccpAddress rule1SccpAddress = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, 0, new GT0001(
                NatureOfAddress.NATIONAL, GT2_pattern_digits), getSSN());
        SccpAddress rule2SccpAddress = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, 0, new GT0001(
                NatureOfAddress.NATIONAL, GT1_pattern_digits), getSSN());
        ...
        User u2 = new User(sccpStack2.getSccpProvider(), a2, a1, getSSN()) {
            ...
            protected boolean matchCalledPartyAddress() {
                ...
                SccpAddress addressToMatch = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_DPC_AND_SSN, getStack2PC(),
                        new GT0001(NatureOfAddress.NATIONAL, "021"), getSSN());
                if (!addressToMatch.equals(udt.getCalledPartyAddress())) {
                    return false;
                }
                return true;
    ...
    public void testRemoteRoutingBasedOnGT() throws Exception {
        ...
        rule1SccpAddress = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, 0, new GT0001(
                NatureOfAddress.NATIONAL, "23456/?/8"), getSSN());
        rule2SccpAddress = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, 0, new GT0001(
                NatureOfAddress.NATIONAL, "02/?"), getSSN());
        ...
        User u1 = new User(sccpStack1.getSccpProvider(), a1, a2, getSSN()) {
            ...
            protected boolean matchCalledPartyAddress() {
                ...
                SccpAddress addressToMatch = new SccpAddress(RoutingIndicator.ROUTING_BASED_ON_DPC_AND_SSN, getStack1PC(),
                        new GT0001(NatureOfAddress.NATIONAL, "2345678"), getSSN());
                if (!addressToMatch.equals(udt.getCalledPartyAddress())) {
                    return false;
                }
                return true;
