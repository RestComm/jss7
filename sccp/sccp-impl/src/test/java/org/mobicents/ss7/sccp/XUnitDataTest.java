...
import org.mobicents.ss7.sccp.impl.parameter.GT0100Impl;
import org.mobicents.ss7.sccp.impl.parameter.ImportanceImpl;
import org.mobicents.ss7.sccp.impl.parameter.ProtocolClassImpl;
import org.mobicents.ss7.sccp.impl.parameter.SccpAddressImpl;
import org.mobicents.ss7.sccp.impl.parameter.SegmentationImpl;
 ...
 *
 */
public class XUnitDataTest extends TestCase {
	
	private static final GlobalTitle _CALLING_PARTY_GLOBAL_TITLE = new GT0100Impl(0, 1, 1, 1, "1111111");
	private static final SccpAddress _CALLING_PARTY = new SccpAddressImpl(1, 1, 4, 1, 1234, 1, _CALLING_PARTY_GLOBAL_TITLE);
	private static final GlobalTitle _CALLED_PARTY_GLOBAL_TITLE = new GT0100Impl(1, 1, 4, 2, "22222222");
	private static final SccpAddress _CALLED_PARTY = new SccpAddressImpl(1, 1, 4, 1, 10922, 2, _CALLED_PARTY_GLOBAL_TITLE);
