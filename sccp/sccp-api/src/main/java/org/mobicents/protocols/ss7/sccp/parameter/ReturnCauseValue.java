...
public enum ReturnCauseValue {
	...
	NO_TRANSLATION_FOR_NATURE(0x0),
	NO_TRANSLATION_FOR_ADDRESS(0x1),
	SUBSYSTEM_CONGESTION(0x2),
	SUBSYSTEM_FAILURE(0x3),
	UNEQUIPED_USER(0x4),
	MTP_FAILURE(0x5),
	NETWORK_CONGESTION(0x6),
	UNQALIFIED(0x7),
	ERR_IN_MSG_TRANSPORT(0x8),
	ERR_IN_LOCAL_PROCESSING(0x9),
	CANNOT_REASEMBLE(0xA),
	SCCP_FAILURE(0xB),
	HOP_COUNTER_VIOLATION(0xC),
	SEG_NOT_SUPPORTED(0xD),
	SEG_FAILURE(0xE);
