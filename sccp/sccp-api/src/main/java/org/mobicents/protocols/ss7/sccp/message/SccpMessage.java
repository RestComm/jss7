 ...
 * connection-oriented services, connectionless services and the management of SCCP.
 * 
...
public interface SccpMessage {
     ...
     * The message type code uniquely defines the function and format of each SCCP message.
     * 
