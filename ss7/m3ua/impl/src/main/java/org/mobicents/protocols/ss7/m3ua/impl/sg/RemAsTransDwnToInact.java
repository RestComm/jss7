...
public class RemAsTransDwnToInact implements TransitionHandler {

    private static final Logger logger = Logger.getLogger(RemAsTransDwnToInact.class);

    private RemAsImpl as = null;
    private FSM fsm;

    public RemAsTransDwnToInact(RemAsImpl as, FSM fsm) {
        this.as = as;
        this.fsm = fsm;
    }
