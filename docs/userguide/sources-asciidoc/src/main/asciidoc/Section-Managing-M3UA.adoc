...
You can retrieve the current settings of the parameter 'maxsequencenumber' by issuing the command `sctp get maxsequencenumber`.
...
You can retrieve the current settings of the parameter 'maxasforroute' by issuing the command `sctp get maxasforroute`.
However as explained above, you cannot modify the settings through the CLI. 
