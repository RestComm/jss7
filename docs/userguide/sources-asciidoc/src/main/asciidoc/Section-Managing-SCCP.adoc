...
Name
	sccp get ssttimerduration_increasefactor 

SYNOPSIS
	sccp get ssttimerduration_increasefactor stackname <stack-name>

DESCRIPTION
	Gets the value for ssttimerduration_increasefactor property.
...
Name
	sccp get ssttimerduration_max 

SYNOPSIS
	sccp get ssttimerduration_max stackname <stack-name>

DESCRIPTION
	Gets the value for ssttimerduration_max property.
...
Name
	sccp get ssttimerduration_min 

SYNOPSIS
	sccp get ssttimerduration_min stackname <stack-name>

DESCRIPTION
	Gets the value for ssttimerduration_min property.
...
SYNOPSIS
	sccp address show <id> stackname <stack-name>
...
SYNOPSIS
	sccp rule show <id> stackname <stack-name>
...
. Between Rules with two GT digits both having an equal number of wildcard "?", the digit whose first appearance of "?" is after other, is at the top of the list.
  For example between Digit1 "80/??/0/???/9" and Digit 2 "800/?????/9", Digit2 is above Digit1.
...
SYNOPSIS
	sccp rss show <id> stackname <stack-name>
...
SYNOPSIS
	sccp lmr show <id> stackname <stack-name>
...
SYNOPSIS
	sccp csp show <id> stackname <stack-name>
