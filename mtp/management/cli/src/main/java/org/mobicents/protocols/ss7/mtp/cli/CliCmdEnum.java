...
public enum CliCmdEnum {
	...
	CliCmdEnum(int cmdInt, String cmdStr) {
		this.cmdInt = cmdInt;
		this.cmdStr = cmdStr;
	}
	...
	public static CliCmdEnum getCommand(int cmdInt) {
		if (cmdInt == 100) {
			return SHOW;
		} else if (cmdInt == 101) {
			return SS7;
	...
	public static CliCmdEnum getCommand(String cmdStr) {
