 ...
 * 
 */
public class FurnishChargingInformationRequestIndicationImpl extends CircuitSwitchedCallMessageImpl implements FurnishChargingInformationRequestIndication {
	...
	public FurnishChargingInformationRequestIndicationImpl() {
	}
