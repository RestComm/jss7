...
public class TimeAndTimezoneImpl implements TimeAndTimezone, CAPAsnPrimitive {
	...
	public void decodeAll(AsnInputStream ansIS) throws CAPParsingComponentException {
		...
		try {
			...
			throw new CAPParsingComponentException("IOException when decoding TimeAndTimezone: " + e.getMessage(), e,
					CAPParsingComponentExceptionReason.MistypedParameter);
		} catch (AsnException e) {
			throw new CAPParsingComponentException("AsnException when decoding TimeAndTimezone: " + e.getMessage(), e,
					CAPParsingComponentExceptionReason.MistypedParameter);
		}
	}
