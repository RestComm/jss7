...
public class DestinationRoutingAddressImpl extends SequenceBase implements DestinationRoutingAddress {
	 ...
	 */
	protected static final XMLFormat<DestinationRoutingAddressImpl> DESTINATION_ROUTING_ADDRESS_XML = new XMLFormat<DestinationRoutingAddressImpl>(DestinationRoutingAddressImpl.class) {

		@Override
		public void read(javolution.xml.XMLFormat.InputElement xml, DestinationRoutingAddressImpl destinationRoutingAddress) throws XMLStreamException {
			DestinationRoutingAddress_CalledPartyNumbers al = xml.get(CALLED_PARTY_NUMBER_LIST, DestinationRoutingAddress_CalledPartyNumbers.class);
			if (al != null) {
		...
		@Override
		public void write(DestinationRoutingAddressImpl destinationRoutingAddress, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
			if (destinationRoutingAddress.calledPartyNumber != null) {
				DestinationRoutingAddress_CalledPartyNumbers al = new DestinationRoutingAddress_CalledPartyNumbers(destinationRoutingAddress.calledPartyNumber);
