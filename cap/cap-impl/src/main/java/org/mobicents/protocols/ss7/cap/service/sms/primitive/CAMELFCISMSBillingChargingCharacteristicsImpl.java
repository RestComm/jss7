 ...
 *
 */
public class CAMELFCISMSBillingChargingCharacteristicsImpl extends SequenceBase implements
        CAMELFCISMSBillingChargingCharacteristics {

    public static final int _ID_fcIBCCCAMELsequence1 = 0;

    public static final int _ID_CAMELFCISMSBillingChargingCharacteristics = 0;

    private FCIBCCCAMELsequence1 fcIBCCCAMELsequence1;

    public CAMELFCISMSBillingChargingCharacteristicsImpl() {
        super("CAMELFCISMSBillingChargingCharacteristics");
    }

    public CAMELFCISMSBillingChargingCharacteristicsImpl(FCIBCCCAMELsequence1 fcIBCCCAMELsequence1) {
        super("CAMELFCISMSBillingChargingCharacteristics");
    ...
    public int getTag() throws CAPException {
        return _ID_CAMELFCISMSBillingChargingCharacteristics;
    }
    ...
    protected void _decode(AsnInputStream asnIS, int length) throws CAPParsingComponentException, IOException,
        ...
        if (this.fcIBCCCAMELsequence1 == null)
            throw new CAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": fcIBCCCAMELsequence1 is mandatory but not found",
                    CAPParsingComponentExceptionReason.MistypedParameter);
