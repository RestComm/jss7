...
public class FurnishChargingInformationGPRSRequestImpl  extends GprsMessageImpl  implements FurnishChargingInformationGPRSRequest {
	...
	private void _decode(AsnInputStream ansIS, int length) throws CAPParsingComponentException, IOException, AsnException, MAPParsingComponentException {
				...
				case Tag.SEQUENCE:
					if (ais.isTagPrimitive())
						throw new CAPParsingComponentException(
								"Error while decoding " + _PrimitiveName + ".fciGPRSBillingChargingCharacteristics: Parameter is primitive",
								CAPParsingComponentExceptionReason.MistypedParameter);
					this.fciGPRSBillingChargingCharacteristics = new CAMELFCIGPRSBillingChargingCharacteristicsImpl();
					((CAMELFCIGPRSBillingChargingCharacteristicsImpl) this.fciGPRSBillingChargingCharacteristics).decodeAll(ais);
					break;
				default:
					ais.advanceElement();
					break;
		...
		if (this.fciGPRSBillingChargingCharacteristics == null)
			throw new CAPParsingComponentException("Error while decoding " + _PrimitiveName + ": parameter fciGPRSBillingChargingCharacteristics is mandatory but not found",
					CAPParsingComponentExceptionReason.MistypedParameter);
	}
	...
	public void encodeData(AsnOutputStream asnOs) throws CAPException {
		...
		((CAMELFCIGPRSBillingChargingCharacteristicsImpl) this.fciGPRSBillingChargingCharacteristics).encodeAll(asnOs);
	}
