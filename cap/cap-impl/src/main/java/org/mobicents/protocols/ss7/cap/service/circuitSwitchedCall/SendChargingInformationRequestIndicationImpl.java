 ...
 * 
 */
public class SendChargingInformationRequestIndicationImpl extends CircuitSwitchedCallMessageImpl implements SendChargingInformationRequestIndication {
	...
	public SendChargingInformationRequestIndicationImpl() {
	}

	public SendChargingInformationRequestIndicationImpl(SCIBillingChargingCharacteristics sciBillingChargingCharacteristics, SendingSideID partyToCharge,
	...
	public void encodeData(AsnOutputStream aos) throws CAPException {
		...
		if (this.sciBillingChargingCharacteristics == null || this.partyToCharge == null)
			throw new CAPException("Error while encoding " + _PrimitiveName + ": sciBillingChargingCharacteristics and partyToCharge must not be null");

		try {

			((SCIBillingChargingCharacteristicsImpl) this.sciBillingChargingCharacteristics).encodeAll(aos, Tag.CLASS_CONTEXT_SPECIFIC,
					_ID_sCIBillingChargingCharacteristics);
