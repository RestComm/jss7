...
public class TransferredVolumeRollOverImpl  implements TransferredVolumeRollOver , CAPAsnPrimitive{
			...
			case _ID_roVolumeIfNoTariffSwitch:
				if (!ais.isTagPrimitive())
					throw new CAPParsingComponentException(
							"Error while decoding " + _PrimitiveName + ".roVolumeIfNoTariffSwitch: Parameter is not primitive",
							CAPParsingComponentExceptionReason.MistypedParameter);
	...
	public void encodeData(AsnOutputStream asnOs) throws CAPException {
		...
		if (this.roVolumeIfNoTariffSwitch == null && this.roVolumeIfTariffSwitch == null || this.roVolumeIfNoTariffSwitch != null
				&& this.roVolumeIfTariffSwitch != null) {
