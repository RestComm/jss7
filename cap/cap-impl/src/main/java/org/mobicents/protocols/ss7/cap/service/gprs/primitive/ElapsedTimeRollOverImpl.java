...
public class ElapsedTimeRollOverImpl  implements ElapsedTimeRollOver , CAPAsnPrimitive{
	...
	private void _decode(AsnInputStream ais, int length) throws CAPParsingComponentException, IOException, AsnException, MAPParsingComponentException {
		...
		if (ais.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC) {
			...
			case _ID_roTimeGPRSIfNoTariffSwitch:
				if (!ais.isTagPrimitive())
					throw new CAPParsingComponentException(
							"Error while decoding " + _PrimitiveName + ".roTimeGPRSIfNoTariffSwitch: Parameter is not primitive",
							CAPParsingComponentExceptionReason.MistypedParameter);
			...
			case _ID_roTimeGPRSIfTariffSwitch:
				if (ais.isTagPrimitive())
					throw new CAPParsingComponentException(
							"Error while decoding " + _PrimitiveName + ".roTimeGPRSIfTariffSwitch: Parameter is  primitive",
							CAPParsingComponentExceptionReason.MistypedParameter);
	...
	public void encodeData(AsnOutputStream asnOs) throws CAPException {
		...
		if (this.roTimeGPRSIfNoTariffSwitch == null && this.roTimeGPRSIfTariffSwitch == null || this.roTimeGPRSIfNoTariffSwitch != null && this.roTimeGPRSIfTariffSwitch != null) {
