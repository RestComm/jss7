...
public class AOCGPRSImpl  extends SequenceBase implements AOCGPRS{
	...
	public AOCGPRSImpl( CAI_GSM0224 aocInitial,
			...
			if (ais.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC) {
				...
				case _ID_aocInitial:
					if (ais.isTagPrimitive())
						throw new CAPParsingComponentException("Error while decoding " + _PrimitiveName + ".aocInitial: Parameter is primitive",
				...
				case _ID_aocSubsequent:
					if (ais.isTagPrimitive())
						throw new CAPParsingComponentException("Error while decoding " + _PrimitiveName + ".aocSubsequent: Parameter is primitive",
								CAPParsingComponentExceptionReason.MistypedParameter);
