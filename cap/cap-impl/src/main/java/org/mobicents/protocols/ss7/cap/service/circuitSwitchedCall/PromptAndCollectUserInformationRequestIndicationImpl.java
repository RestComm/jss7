 ...
 * 
 */
public class PromptAndCollectUserInformationRequestIndicationImpl extends CircuitSwitchedCallMessageImpl implements PromptAndCollectUserInformationRequestIndication {
	...
	public PromptAndCollectUserInformationRequestIndicationImpl() {
	}

	public PromptAndCollectUserInformationRequestIndicationImpl(CollectedInfo collectedInfo, Boolean disconnectFromIPForbidden,
