 ...
 * 
 */
public class EstablishTemporaryConnectionRequestIndicationImpl extends CircuitSwitchedCallMessageImpl implements EstablishTemporaryConnectionRequestIndication {
	...
	public EstablishTemporaryConnectionRequestIndicationImpl(boolean isCAPVersion3orLater) {
		this.isCAPVersion3orLater = isCAPVersion3orLater;
	}

	public EstablishTemporaryConnectionRequestIndicationImpl(Digits assistingSSPIPRoutingAddress, Digits correlationID, ScfID scfID, CAPExtensions extensions,
	...
	private void _decode(AsnInputStream ansIS, int length) throws CAPParsingComponentException, IOException, AsnException {
		...
		if (this.assistingSSPIPRoutingAddress == null)
			throw new CAPParsingComponentException("Error while decoding " + _PrimitiveName
					+ ": parameter assistingSSPIPRoutingAddress is mandatory but not found", CAPParsingComponentExceptionReason.MistypedParameter);
	}
	...
	public void encodeData(AsnOutputStream aos) throws CAPException {
		...
		try {
			((DigitsImpl) this.assistingSSPIPRoutingAddress).encodeAll(aos, Tag.CLASS_CONTEXT_SPECIFIC, _ID_assistingSSPIPRoutingAddress);
			...
			if (this.serviceInteractionIndicatorsTwo != null) {
				if (this.isCAPVersion3orLater) {
					...
					((ServiceInteractionIndicatorsTwoImpl) this.serviceInteractionIndicatorsTwo).encodeAll(aos, Tag.CLASS_CONTEXT_SPECIFIC, _ID_callSegmentID);
				}
			}
