...
public class CAPDialogGprsImpl extends CAPDialogImpl implements CAPDialogGprs {
	...
	public Long addInitialDpGprsRequest(int serviceKey,
			...
			throws CAPException {
		return addInitialDpGprsRequest(_Timer_Default, serviceKey, gprsEventType, msisdn, imsi,
				timeAndTimezone, gprsMSClass, endUserAddress, qualityOfService, accessPointName, 
	...
	public Long addInitialDpGprsRequest(int customInvokeTimeout,
		...
		if (this.appCntx != CAPApplicationContext.CapV3_gprsSSF_gsmSCF )
			throw new CAPException(
					"Bad application context name for InitialDpGprsRequest: must be CapV3_gprsSSF_gsmSCF");
	...
	public Long addApplyChargingGPRSRequest(int customInvokeTimeout,ChargingCharacteristics chargingCharacteristics,
		...
		ApplyChargingGPRSRequestImpl req = new ApplyChargingGPRSRequestImpl(chargingCharacteristics,
				tariffSwitchInterval, pdpID);
	...
	public Long addFurnishChargingInformationGPRSRequest(
		...
		FurnishChargingInformationGPRSRequestImpl req = new FurnishChargingInformationGPRSRequestImpl(fciGPRSBillingChargingCharacteristics);
	...
	public Long addSendChargingInformationGPRSRequest(
		...
		SendChargingInformationGPRSRequestImpl req = new SendChargingInformationGPRSRequestImpl(sciGPRSBillingChargingCharacteristics);
	...
	public Long addApplyChargingReportGPRSRequest(
		...
		return addApplyChargingReportGPRSRequest(_Timer_Default, chargingResult, qualityOfService, active, pdpID, chargingRollOver);
	}
	...
	public Long addApplyChargingReportGPRSRequest(int customInvokeTimeout,
		...
		ApplyChargingReportGPRSRequestImpl req = new ApplyChargingReportGPRSRequestImpl(chargingResult, 
				qualityOfService, active, pdpID, chargingRollOver);
	...
	public Long addEventReportGPRSRequest(int customInvokeTimeout,
		...
		EventReportGPRSRequestImpl req = new EventReportGPRSRequestImpl(gprsEventType, miscGPRSInfo, gprsEventSpecificInformation, pdpID);
