 ...
 * 
 */
public class CallInformationReportRequestIndicationTest {

	public byte[] getData1() {
		return new byte[] { 48, 44, (byte) 160, 37, 48, 8, (byte) 128, 1, 2, (byte) 161, 3, (byte) 130, 1, 0, 48, 14, (byte) 128, 1, 1, (byte) 161, 9,
				(byte) 129, 7, 2, 17, 33, 3, 1, 112, (byte) 129, 48, 9, (byte) 128, 1, 30, (byte) 161, 4, (byte) 158, 2, (byte) 130, (byte) 145, (byte) 163, 3,
				(byte) 129, 1, 2 };
	}

	public byte[] getData2() {
		return new byte[] { 48, 64, (byte) 160, 37, 48, 8, (byte) 128, 1, 2, (byte) 161, 3, (byte) 130, 1, 0, 48, 14, (byte) 128, 1, 1, (byte) 161, 9,
				(byte) 129, 7, 2, 17, 33, 3, 1, 112, (byte) 129, 48, 9, (byte) 128, 1, 30, (byte) 161, 4, (byte) 158, 2, (byte) 130, (byte) 145, (byte) 162,
				18, 48, 5, 2, 1, 2, (byte) 129, 0, 48, 9, 2, 1, 3, 10, 1, 1, (byte) 129, 1, (byte) 255, (byte) 163, 3, (byte) 129, 1, 2 };
	}
	...
	public void testDecode() throws Exception {
		...
		CallInformationReportRequestIndicationImpl elem = new CallInformationReportRequestIndicationImpl();
		int tag = ais.readTag();
		elem.decodeAll(ais);

		assertEquals(elem.getRequestedInformationList().get(0).getRequestedInformationType(), RequestedInformationType.callConnectedElapsedTime);
		assertEquals((int) elem.getRequestedInformationList().get(0).getCallConnectedElapsedTimeValue(), 0);
		assertEquals(elem.getRequestedInformationList().get(1).getRequestedInformationType(), RequestedInformationType.callStopTime);
		...
		assertEquals(elem.getRequestedInformationList().get(2).getRequestedInformationType(), RequestedInformationType.releaseCause);
		...
		elem = new CallInformationReportRequestIndicationImpl();
		tag = ais.readTag();
		elem.decodeAll(ais);
	...
	public void testEncode() throws Exception {
		...
		CallInformationReportRequestIndicationImpl elem = new CallInformationReportRequestIndicationImpl(requestedInformationList, null, legID);
		AsnOutputStream aos = new AsnOutputStream();
		elem.encodeAll(aos);
		assertTrue(Arrays.equals(aos.toByteArray(), this.getData1()));

		elem = new CallInformationReportRequestIndicationImpl(requestedInformationList, CAPExtensionsTest.createTestCAPExtensions(), legID);
