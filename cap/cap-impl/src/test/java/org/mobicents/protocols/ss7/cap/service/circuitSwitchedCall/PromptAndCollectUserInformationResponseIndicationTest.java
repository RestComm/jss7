 ...
 * 
 */
public class PromptAndCollectUserInformationResponseIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		PromptAndCollectUserInformationResponseIndicationImpl elem = new PromptAndCollectUserInformationResponseIndicationImpl();
		int tag = ais.readTag();
		assertEquals(tag, 0);
		elem.decodeAll(ais);
	...
	public void testEncode() throws Exception {
		...
		PromptAndCollectUserInformationResponseIndicationImpl elem = new PromptAndCollectUserInformationResponseIndicationImpl(digitsResponse);
