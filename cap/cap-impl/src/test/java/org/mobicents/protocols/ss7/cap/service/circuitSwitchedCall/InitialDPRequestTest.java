...
public class InitialDPRequestTest {
	...
	public byte[] getData1() {
		return new byte[] { 48, 107, (byte) 128, 1, 110, (byte) 130, 8, (byte) 131, (byte) 144, 33, 114, 16, (byte) 144, 0, 0, (byte) 131, 3, 3, (byte) 151,
				87, (byte) 133, 1, 10, (byte) 140, 6, (byte) 131, 20, 7, 1, 9, 0, (byte) 187, 5, (byte) 128, 3, (byte) 128, (byte) 144, (byte) 163, (byte) 156,
				1, 2, (byte) 157, 6, (byte) 131, 20, 7, 1, 9, 0, (byte) 158, 2, 3, 97, (byte) 159, 50, 8, 6, 7, (byte) 146, 9, 16, 4, (byte) 145, (byte) 249,
	...
	public byte[] getData2() {
		return new byte[] { 48, -127, -90, -128, 1, 110, -126, 8, -125, -112, 33, 114, 16, -112, 0, 0, -125, 3, 3, -105, 87, -123, 1, 10, -120, 1, 19, -118, 2,
				22, 11, -116, 6, -125, 20, 7, 1, 9, 0, -81, 18, 48, 5, 2, 1, 2, -127, 0, 48, 9, 2, 1, 3, 10, 1, 1, -127, 1, -1, -105, 2, 8, 9, -103, 2, 20, 2,
				-69, 5, -128, 3, -128, -112, -93, -100, 1, 2, -99, 6, -125, 20, 7, 1, 9, 0, -98, 2, 3, 97, -97, 50, 8, 6, 7, -110, 9, 16, 4, -111, -7, -65, 51,
				2, -126, 0, -65, 52, 3, 2, 1, 111, -65, 53, 3, -125, 1, 17, -97, 54, 5, 19, -6, 61, 61, -22, -97, 55, 6, -111, 34, 112, 87, 0, 112, -97, 56, 7,
				-111, 20, -121, 8, 80, 64, -9, -97, 57, 8, 2, 80, 17, 66, 49, 1, 101, 0, -97, 58, 0, -65, 59, 8, -127, 6, -111, 34, 112, 87, 0, 112 };
	}
...
//		InitialDPArgExtension initialDPArgExtension, boolean isCAPVersion3orLater
	...
	public void testXMLSerialize() throws Exception {
		...
		InitialDPArgExtensionImpl initialDPArgExtension = new InitialDPArgExtensionImpl(gmscAddress, null, null, null, null, null, null, null, null, null,
				null, false, null, false);
		IPSSPCapabilitiesImpl IPSSPCapabilities = new IPSSPCapabilitiesImpl(true, true, false, false, true, null);
		LocationNumberImpl ln = new LocationNumberImpl(LocationNumber._NAI_NATIONAL_SN, "12345333111", LocationNumber._NPI_TELEX,
		...
		UserTeleserviceInformationImpl uti = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_NATIONAL,
		...
		InitialDPRequestImpl original = new InitialDPRequestImpl(110, calledPartyNumber, callingPartyNumber, callingPartysCategory,
				CGEncountered.manualCGencountered, IPSSPCapabilities, locationNumber, originalCalledPartyID, CAPExtensionsTest.createTestCAPExtensions(),
		...
		assertEquals(copy.getIPSSPCapabilities().getIPRoutingAddressSupported(), original.getIPSSPCapabilities().getIPRoutingAddressSupported());
		assertEquals(copy.getIPSSPCapabilities().getVoiceInformationSupportedViaSpeechRecognition(), original.getIPSSPCapabilities().getVoiceInformationSupportedViaSpeechRecognition());
		...
		assertEquals(copy.getBearerCapability().getBearerCap().getData(), original.getBearerCapability().getBearerCap().getData());
		...
		assertEquals(copy.getInitialDPArgExtension().getGmscAddress().getAddress(), original.getInitialDPArgExtension().getGmscAddress().getAddress());
