 ...
 *
 */
public class CAMELFCISMSBillingChargingCharacteristicsTest {
	
	public byte[] getData() {
		return new byte[] { -96, 15, -96, 13, -128, 8, 48, 6, -128, 1, 3, -118, 1, 1, -127, 1, 1 };
	};
	...
	public void testDecode() throws Exception {
		...
		int tag = asn.readTag();
		CAMELFCISMSBillingChargingCharacteristicsImpl prim = new CAMELFCISMSBillingChargingCharacteristicsImpl();
		prim.decodeAll(asn);
		
		assertEquals(tag, CAMELFCISMSBillingChargingCharacteristicsImpl._ID_CAMELFCISMSBillingChargingCharacteristics);
		assertEquals(asn.getTagClass(), Tag.CLASS_CONTEXT_SPECIFIC);
		
		FCIBCCCAMELsequence1 fcIBCCCAMELsequence1  = prim.getFCIBCCCAMELsequence1();
	...
	public void testEncode() throws Exception {
		...
		FCIBCCCAMELsequence1Impl fcIBCCCAMELsequence1 = new FCIBCCCAMELsequence1Impl(freeFormatData, AppendFreeFormatData.append);
		CAMELFCISMSBillingChargingCharacteristicsImpl prim = new CAMELFCISMSBillingChargingCharacteristicsImpl(fcIBCCCAMELsequence1);
