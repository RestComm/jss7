...
public class QualityOfServiceTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 35, -96, 5, -128, 3, 4, 7, 7, -95, 4, -127, 2, 1, 7, -94, 5, -128, 3, 4, 7, 7, -93, 3, -128, 1, 52, -92, 3, -128, 1, 53, -91, 3, -128, 1, 54};
	};
	...
	public void testDecode() throws Exception {
		...
		assertTrue(Arrays.equals(prim.getRequestedQoSExtension().getSupplementToLongQoSFormat().getData(), this.getEncodedqos2Subscribed1()));
		
		assertTrue(Arrays.equals(prim.getSubscribedQoSExtension().getSupplementToLongQoSFormat().getData(), this.getEncodedqos2Subscribed2()));
		
		assertTrue(Arrays.equals(prim.getNegotiatedQoSExtension().getSupplementToLongQoSFormat().getData(), this.getEncodedqos2Subscribed3()));
	}
	...
	public void testEncode() throws Exception {
		...
		QualityOfServiceImpl prim = new QualityOfServiceImpl(requestedQoS, subscribedQoS,
