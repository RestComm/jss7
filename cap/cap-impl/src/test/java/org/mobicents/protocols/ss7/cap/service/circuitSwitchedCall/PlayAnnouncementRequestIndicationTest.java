 ...
 * 
 */
public class PlayAnnouncementRequestIndicationTest {

	public byte[] getData1() {
		return new byte[] { 48, 43, (byte) 160, 8, (byte) 161, 6, (byte) 128, 1, 10, (byte) 129, 1, 100, (byte) 129, 1, (byte) 255, (byte) 130, 1, 0,
				(byte) 163, 18, 48, 5, 2, 1, 2, (byte) 129, 0, 48, 9, 2, 1, 3, 10, 1, 1, (byte) 129, 1, (byte) 255, (byte) 133, 1, 22, (byte) 159, 51, 1,
				(byte) 255 };
	}
	...
	public void testDecode() throws Exception {
		...
		PlayAnnouncementRequestIndicationImpl elem = new PlayAnnouncementRequestIndicationImpl();
		int tag = ais.readTag();
	...
	public void testEncode() throws Exception {
		...
		PlayAnnouncementRequestIndicationImpl elem = new PlayAnnouncementRequestIndicationImpl(informationToSend, true, false,
