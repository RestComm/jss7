 ...
 * 
 */
public class InitialDPRequestIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		InitialDPRequestIndicationImpl elem = new InitialDPRequestIndicationImpl(false);
		int tag = ais.readTag();
		elem.decodeAll(ais);
		...
		elem = new InitialDPRequestIndicationImpl(false);
		tag = ais.readTag();
		elem.decodeAll(ais);
		assertEquals(elem.getServiceKey(), 110);
		assertTrue(Arrays.equals(elem.getCalledPartyNumber().getData(), getDataCalledPartyNumber()));
	...
	public void testEncode() throws Exception {
		...
		InitialDPRequestIndicationImpl elem = new InitialDPRequestIndicationImpl(110, calledPartyNumber, callingPartyNumber, callingPartysCategory, null, null,
