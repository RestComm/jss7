 ...
 * 
 */
public class RequestReportBCSMEventRequestIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		RequestReportBCSMEventRequestIndicationImpl elem = new RequestReportBCSMEventRequestIndicationImpl();
		int tag = ais.readTag();
		elem.decodeAll(ais);
		...
		elem = new RequestReportBCSMEventRequestIndicationImpl();
		tag = ais.readTag();
		elem.decodeAll(ais);
		assertEquals(elem.getBCSMEventList().size(), 7);
		assertEquals(elem.getBCSMEventList().get(0).getEventTypeBCSM(), EventTypeBCSM.routeSelectFailure);
	...
	public void testEncode() throws Exception {
		...
		RequestReportBCSMEventRequestIndicationImpl elem = new RequestReportBCSMEventRequestIndicationImpl(bcsmEventList, null);
		AsnOutputStream aos = new AsnOutputStream();
		elem.encodeAll(aos);
		assertTrue(Arrays.equals(aos.toByteArray(), this.getData1()));

		elem = new RequestReportBCSMEventRequestIndicationImpl(bcsmEventList, CAPExtensionsTest.createTestCAPExtensions());
