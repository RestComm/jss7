 ...
 * 
 */
public class ApplyChargingRequestIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		ApplyChargingRequestIndicationImpl elem = new ApplyChargingRequestIndicationImpl();
		int tag = ais.readTag();
		elem.decodeAll(ais);
		...
		elem = new ApplyChargingRequestIndicationImpl();
		tag = ais.readTag();
		elem.decodeAll(ais);
...
//		AudibleIndicator audibleIndicator, CAPExtensions extensions, boolean isCAPVersion3orLater
		...
		ApplyChargingRequestIndicationImpl elem = new ApplyChargingRequestIndicationImpl(aChBillingChargingCharacteristics, partyToCharge, null, null);
...
//		CAPExtensions extensions, AChChargingAddress aChChargingAddress
		...
		elem = new ApplyChargingRequestIndicationImpl(aChBillingChargingCharacteristics, partyToCharge, CAPExtensionsTest.createTestCAPExtensions(), null);
