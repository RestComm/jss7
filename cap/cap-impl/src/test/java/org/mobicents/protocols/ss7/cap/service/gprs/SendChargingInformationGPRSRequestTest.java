...
public class SendChargingInformationGPRSRequestTest {
	...
	public byte[] getData() {
		return new byte[] { 48, 46, -128, 44, 48, 42, -96, 37, -96, 21, -128,
				1, 1, -127, 1, 2, -126, 1, 3, -125, 1, 4, -124, 1, 5, -123, 1,
				6, -122, 1, 7, -95, 12, -96, 6, -125, 1, 4, -124, 1, 5, -127,
				2, 0, -34, -127, 1, 1 };
	};
	...
	public void testDecode() throws Exception {
		...
		assertEquals((int) prim.getSCIGPRSBillingChargingCharacteristics().getAOCGPRS().getAOCSubsequent().getCAI_GSM0224().getE4(), 4);
		assertEquals((int) prim.getSCIGPRSBillingChargingCharacteristics().getAOCGPRS().getAOCSubsequent().getCAI_GSM0224().getE5(), 5);
		...
		assertEquals((int) prim.getSCIGPRSBillingChargingCharacteristics().getAOCGPRS().getAOCSubsequent().getTariffSwitchInterval(), 222);
	...
	public void testEncode() throws Exception {	
		...
		SendChargingInformationGPRSRequestImpl prim = new SendChargingInformationGPRSRequestImpl(sciGPRSBillingChargingCharacteristics);
