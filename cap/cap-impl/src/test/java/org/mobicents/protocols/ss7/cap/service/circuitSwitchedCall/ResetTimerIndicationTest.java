 ...
 * 
 */
public class ResetTimerIndicationTest {
	...
	public void testDecode() throws Exception {
		...
		ResetTimerRequestIndicationImpl elem = new ResetTimerRequestIndicationImpl();
		int tag = ais.readTag();
		elem.decodeAll(ais);
	...
	public void testEncode() throws Exception {
		...
		ResetTimerRequestIndicationImpl elem = new ResetTimerRequestIndicationImpl(TimerID.tssf, 1000, CAPExtensionsTest.createTestCAPExtensions(), 100);
