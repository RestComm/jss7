...
public class PDPContextEstablishmentSpecificInformationTest {
	...
	public void testDecode() throws Exception {
		...
		assertEquals(tag,PDPContextEstablishmentSpecificInformationImpl._ID_PDPContextEstablishmentSpecificInformation);
		...
		assertTrue(Arrays.equals(prim.getQualityOfService().getSubscribedQoSExtension().getSupplementToLongQoSFormat().getData(), this.getEncodedqos2Subscribed2()));
		assertTrue(Arrays.equals(prim.getQualityOfService().getNegotiatedQoSExtension().getSupplementToLongQoSFormat().getData(), this.getEncodedqos2Subscribed3()));
