...
public class AssistRequestInstructionsRequestIndicationTest {

	public byte[] getData1() {
		return new byte[] { 48, 33, (byte) 128, 8, 0, (byte) 128, 20, 17, 33, 34, 51, 3, (byte) 130, 1, 111, (byte) 163, 18, 48, 5, 2, 1, 2, (byte) 129, 0, 48,
	...
	public void testDecode() throws Exception {
		...
		AssistRequestInstructionsRequestIndicationImpl elem = new AssistRequestInstructionsRequestIndicationImpl();
		int tag = ais.readTag();
		elem.decodeAll(ais);
...
//		boolean numberIncomplete, int screeningIndicator
		...
		AssistRequestInstructionsRequestIndicationImpl elem = new AssistRequestInstructionsRequestIndicationImpl(correlationID, ipSSPCapabilities,
