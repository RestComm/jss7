...
public class CallInformationRequestRequestTest {
	...
	public void testEncode() throws Exception {
		...
		CallInformationRequestRequestImpl elem = new CallInformationRequestRequestImpl(requestedInformationTypeList, null, legID);
		...
		elem = new CallInformationRequestRequestImpl(requestedInformationTypeList, CAPExtensionsTest.createTestCAPExtensions(), legID);
