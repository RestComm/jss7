 ...
 * 
 */
public class EstablishTemporaryConnectionIndicationTest {

	public byte[] getData1() {
		return new byte[] { 48, 49, (byte) 128, 5, 1, 1, 1, 17, 34, (byte) 129, 5, 64, 1, 2, 3, 4, (byte) 131, 4, 5, 6, 7, 8, (byte) 164, 18, 48, 5, 2, 1, 2,
				(byte) 129, 0, 48, 9, 2, 1, 3, 10, 1, 1, (byte) 129, 1, (byte) 255, (byte) 167, 3, (byte) 130, 1, 1, (byte) 159, 50, 1, 11 };
	}

	public byte[] getData2() {
		return new byte[] { 48, 52, (byte) 128, 5, 1, 1, 1, 17, 34, (byte) 129, 5, 64, 1, 2, 3, 4, (byte) 131, 4, 5, 6, 7, 8, (byte) 164, 18, 48, 5, 2, 1, 2,
	...
	public void testDecode() throws Exception {
		...
		EstablishTemporaryConnectionRequestIndicationImpl elem = new EstablishTemporaryConnectionRequestIndicationImpl(false);
		int tag = ais.readTag();
		elem.decodeAll(ais);
		...
		elem = new EstablishTemporaryConnectionRequestIndicationImpl(true);
		tag = ais.readTag();
		elem.decodeAll(ais);
...
//		CwTreatmentIndicator cwTreatmentIndicator, EctTreatmentIndicator ectTreatmentIndicator
		...
		EstablishTemporaryConnectionRequestIndicationImpl elem = new EstablishTemporaryConnectionRequestIndicationImpl(assistingSSPIPRoutingAddress, correlationID, scfID,
				CAPExtensionsTest.createTestCAPExtensions(), null, serviceInteractionIndicatorsTwo, null, naOliInfo, null, null, null, false);
...
//		LocationNumberCap chargeNumber, OriginalCalledNumberCap originalCalledPartyID, CallingPartyNumberCap callingPartyNumber,
//		boolean isCAPVersion3orLater
		
		elem = new EstablishTemporaryConnectionRequestIndicationImpl(assistingSSPIPRoutingAddress, correlationID, scfID,
				CAPExtensionsTest.createTestCAPExtensions(), null, serviceInteractionIndicatorsTwo, 8, naOliInfo, null, null, null, true);
