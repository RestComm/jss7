 ...
 * 
 */
public class PromptAndCollectUserInformationRequestIndicationTest {

	public byte[] getData1() {
		return new byte[] { 48, 47, (byte) 160, 5, (byte) 160, 3, (byte) 129, 1, 10, (byte) 129, 1, 0, (byte) 162, 8, (byte) 161, 6, (byte) 128, 1, 10,
				(byte) 129, 1, 100, (byte) 163, 18, 48, 5, 2, 1, 2, (byte) 129, 0, 48, 9, 2, 1, 3, 10, 1, 1, (byte) 129, 1, (byte) 255, (byte) 132, 1, 22,
				(byte) 159, 51, 1, 0 };
	}
	...
	public void testDecode() throws Exception {
		...
		PromptAndCollectUserInformationRequestIndicationImpl elem = new PromptAndCollectUserInformationRequestIndicationImpl();
		int tag = ais.readTag();
	...
	public void testEncode() throws Exception {
		...
		CollectedDigitsImpl collectedDigits = new CollectedDigitsImpl(null, 10, null, null, null, null, null, null, null, null, null);
...
//		Boolean voiceBack
		...
		PromptAndCollectUserInformationRequestIndicationImpl elem = new PromptAndCollectUserInformationRequestIndicationImpl(collectedInfo, false,
