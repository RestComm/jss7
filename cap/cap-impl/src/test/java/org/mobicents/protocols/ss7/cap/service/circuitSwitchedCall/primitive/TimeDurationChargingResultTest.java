...
public class TimeDurationChargingResultTest {
	...
	public byte[] getData2() {
		return new byte[] { (byte) 160, 32, (byte) 160, 3, (byte) 129, 1, 2, (byte) 161, 3, (byte) 128, 1, 55, (byte) 131, 0, (byte) 164, 18, 48, 5, 2, 1, 2,
	...
	public void testEncode() throws Exception {
		...
		elem = new TimeDurationChargingResultImpl(partyToCharge, ti, true, true, CAPExtensionsTest.createTestCAPExtensions(), null);
		// ReceivingSideID partyToCharge, TimeInformation timeInformation, boolean legActive,
		// boolean callLegReleasedAtTcpExpiry, CAPExtensions extensions, AChChargingAddress aChChargingAddress
