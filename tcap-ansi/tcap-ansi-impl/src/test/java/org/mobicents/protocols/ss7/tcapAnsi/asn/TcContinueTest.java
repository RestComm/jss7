...
//        int tag = ais.readTag();
//        assertEquals(TCConversationMessage._TAG, tag, "Expected TCInvoke");
//        TCConversationMessage tcm = TcapFactory.createTCContinueMessage(ais);
//
...
//        AsnInputStream ais = new AsnInputStream(b);
//        int tag = ais.readTag();
//        assertEquals(TCConversationMessage._TAG, tag, "Expected TCContinue");
//        TCConversationMessage tcm = TcapFactory.createTCContinueMessage(ais);
//
//        assertNull(tcm.getDialogPortion(), "Dialog portion should not be present");
//        // assertEquals(144965633L, tcm.getDestinationTransactionId(),"Destination transaction id does not match");
