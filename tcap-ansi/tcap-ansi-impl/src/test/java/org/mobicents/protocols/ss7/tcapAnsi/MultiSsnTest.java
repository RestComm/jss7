...
public class MultiSsnTest extends SccpHarness {
    ...
    public void setUp() throws Exception {
        ...
        GlobalTitle gtPattern = super.parameterFactory.createGlobalTitle("*", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme());
        ...
        GlobalTitle gtRa11 = super.parameterFactory.createGlobalTitle("1111", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme());
//        GlobalTitle gtRa12 = super.parameterFactory.createGlobalTitle("11112222", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme(), NatureOfAddress.INTERNATIONAL);
        ...
        router1.addRule(1, RuleType.SOLITARY, LoadSharingAlgorithm.Bit0, OriginationType.LOCAL, pattern, "K", 1, -1, null, 0);
        router1.addRule(2, RuleType.SOLITARY, LoadSharingAlgorithm.Bit0, OriginationType.REMOTE, pattern, "K", 2, -1, null, 0);
...
//        GlobalTitle gtRa22 = super.parameterFactory.createGlobalTitle("11111111", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme(), NatureOfAddress.INTERNATIONAL);
        ...
        router2.addRule(1, RuleType.SOLITARY, LoadSharingAlgorithm.Bit0, OriginationType.LOCAL, pattern, "K", 1, -1, null, 0);
        router2.addRule(2, RuleType.SOLITARY, LoadSharingAlgorithm.Bit0, OriginationType.REMOTE, pattern, "K", 2, -1, null, 0);
        ...
        GlobalTitle gt1 = super.parameterFactory.createGlobalTitle("11111111", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme());
        GlobalTitle gt2 = super.parameterFactory.createGlobalTitle("11112222", 0, NumberingPlan.ISDN_TELEPHONY, new BCDEvenEncodingScheme());
