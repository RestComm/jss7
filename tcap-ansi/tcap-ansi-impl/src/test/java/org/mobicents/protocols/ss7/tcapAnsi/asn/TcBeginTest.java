...
import org.mobicents.protocols.ss7.tcapAnsi.asn.UserInformationImpl;
...
//        TCQueryMessage tcm = TcapFactory.createTCBeginMessage();
...
//        int tag = ais.readTag();
//        assertEquals(TCQueryMessage._TAG, tag, "Expected TCInvoke");
//        TCQueryMessage tcm = TcapFactory.createTCBeginMessage(ais);
//
...
//        AsnInputStream ais = new AsnInputStream(b);
//        int tag = ais.readTag();
//        assertEquals(TCQueryMessage._TAG, tag, "Expected TCBegin");
//        TCQueryMessage tcm = TcapFactory.createTCBeginMessage(ais);
//
...
//        ReturnResultNotLast rr = (ReturnResultNotLast) c;
