    ...
    public void decode(AsnInputStream ais) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(PAbortCause.BadlyStructuredTransactionPortion, RejectProblem.generalBadlyStructuredCompPortion,
                    "IOException while decoding OperationCode: " + e.getMessage(), e);
        } catch (AsnException e) {
            throw new ParseException(PAbortCause.BadlyStructuredTransactionPortion, RejectProblem.generalBadlyStructuredCompPortion,
                    "AsnException while decoding OperationCode: " + e.getMessage(), e);
        }
    }
    ...
    public void encode(AsnOutputStream aos) throws EncodeException {
        ...
        try {
            if (this.type == OperationCodeType.National && this.nationalOperationCode != null) {
                aos.writeInteger(this.nationalOperationCode);
            } else if (this.type == OperationCodeType.Private && this.privateOperationCode != null) {
                aos.writeInteger(this.privateOperationCode);
            } else {
                throw new EncodeException("Operation code: No Operation code set!");
            }
