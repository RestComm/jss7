 ...
 * <FONT face="Times New Roman" size="3">Circuit Group Blocking
 * (CGB)&nbsp;message sent to the node to permit the switching equipment or
 * maintenance system to remove from (and return to) traffic a group of
 * circuits/CICs. A node receiving a Circuit/CIC Group Blocking message must be
 * able to accept incoming calls on the group of blocked circuits/CICs unless it
 * has also sent a Circuit/CIC Group Blocking message. </FONT></TD>
 * </TR>
 * </TABLE>
 * 
 * </TD>
...
public interface CircuitGroupBlockingMessage extends ISUPMessage {
	 ...
	 */
	public static final int MESSAGE_CODE = 0x18;
