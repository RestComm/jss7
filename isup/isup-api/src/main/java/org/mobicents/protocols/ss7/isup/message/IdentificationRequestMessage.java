 ...
 * <FONT face="Times New Roman" size="3">Identification Request
 * (IDR)&nbsp;message sent in the backward direction to request action regarding
 * the malicious call identification supplementary service. </FONT></TD>
 * </TR>
 * </TABLE>
 * </TD>
 * </TR>
...
public interface IdentificationRequestMessage extends ISUPMessage {
	 ...
	 */
	public static final int MESSAGE_CODE = 0x36;
}
