 ...
 * <FONT face="Times New Roman" size="3">User Part Available (UPA)&nbsp;message
 * sent in either direction as a response to a user part test message, to
 * indicate that the user part is available. </FONT></TD>
 * </TR>
 * </TABLE>
 * </TD>
 * 
