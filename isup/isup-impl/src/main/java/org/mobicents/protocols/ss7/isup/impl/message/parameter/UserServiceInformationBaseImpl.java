...
//				b[byteLength] |= 0x80;
	...
	protected static final XMLFormat<UserServiceInformationBaseImpl> ISUP_USER_SERVICE_INFORMATION_BASE_XML = new XMLFormat<UserServiceInformationBaseImpl>(UserServiceInformationBaseImpl.class) {
		...
		@Override
		public void read(javolution.xml.XMLFormat.InputElement xml, UserServiceInformationBaseImpl userServiceInformation) throws XMLStreamException {
			userServiceInformation.codingStandart = xml.getAttribute(CODING_STANDART, DEFAULT_VALUES);
			userServiceInformation.informationTransferCapability = xml.getAttribute(INFORMATION_TRANSFER_CAPABILITY, DEFAULT_VALUES);
			userServiceInformation.transferMode = xml.getAttribute(TRANSFER_MODE, DEFAULT_VALUES);
			userServiceInformation.customInformationTransferRate = xml.getAttribute(CUSTOM_INFORMATION_TRANSFERRATE, DEFAULT_VALUES);
		...
		@Override
		public void write(UserServiceInformationBaseImpl userServiceInformation, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
