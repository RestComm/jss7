...
public class GenericDigitsTest {
	...
	public void testEncode() throws Exception {
		...
		GenericDigitsImpl prim = new GenericDigitsImpl(GenericDigits._ENCODING_SCHEME_BCD_ODD, GenericDigits._TOD_BGCI, getEncodedData());
//		int encodingScheme, int typeOfDigits, byte[] digits 
	...
	public void testXMLSerialize() throws Exception {
		...
		GenericDigitsImpl original = new GenericDigitsImpl(GenericDigits._ENCODING_SCHEME_BCD_ODD, GenericDigits._TOD_BGCI, getEncodedData());
