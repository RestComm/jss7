...
public class OriginalCalledNumberTest {
	...
	public void testEncode() throws Exception {
		...
		OriginalCalledNumberImpl prim = new OriginalCalledNumberImpl(OriginalCalledNumber._NAI_NATIONAL_SN, "12345", OriginalCalledNumber._NPI_TELEX,
...
//		int natureOfAddresIndicator, String address, int numberingPlanIndicator, int addressRepresentationRestrictedIndicator
	...
	public void testXMLSerialize() throws Exception {
		...
		OriginalCalledNumberImpl original = new OriginalCalledNumberImpl(OriginalCalledNumber._NAI_NATIONAL_SN, "12345", OriginalCalledNumber._NPI_TELEX,
				OriginalCalledNumber._APRI_RESTRICTED);
