...
public class UserTeleserviceInformationTest extends ParameterHarness {
	...
	public void testEncode() throws Exception {
		...
		UserTeleserviceInformationImpl prim = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_NATIONAL, UserTeleserviceInformation._INTERPRETATION_FHGCI,
		...
		prim = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_ITU_T, UserTeleserviceInformation._INTERPRETATION_FHGCI,
		...
		prim = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_ITU_T, UserTeleserviceInformation._INTERPRETATION_FHGCI,
				UserTeleserviceInformation._PRESENTATION_METHOD_HLPP, UserTeleserviceInformation._HLCI_AUDIOGRAPHIC_CONF,
				UserTeleserviceInformation._EACI_CSIC_H221, true);
	...
	public void testXMLSerialize() throws Exception {
		...
		UserTeleserviceInformationImpl original = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_ITU_T,
		...
		original = new UserTeleserviceInformationImpl(UserTeleserviceInformation._CODING_STANDARD_ITU_T, UserTeleserviceInformation._INTERPRETATION_FHGCI,
				UserTeleserviceInformation._PRESENTATION_METHOD_HLPP, UserTeleserviceInformation._HLCI_AUDIOGRAPHIC_CONF,
				UserTeleserviceInformation._EACI_CSIC_H221, true);
	...
	public void testBody2EncodedValues() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, IOException, ParameterException {
		...
		String[] methodNames = { "getPresentationMethod", "getInterpretation", "getCodingStandard", "getHighLayerCharIdentification", "getEVideoTelephonyCharIdentification" };
		Object[] expectedValues = { UserTeleserviceInformationImpl._PRESENTATION_METHOD_HLPP, UserTeleserviceInformationImpl._INTERPRETATION_FHGCI, UserTeleserviceInformationImpl._CODING_STANDARD_ISO_IEC,
				UserTeleserviceInformationImpl._HLCI_AUDIO_VID_LOW_RANGE, UserTeleserviceInformationImpl._EACI_CSIC_AA_3_1_CALL };
		super.testValues(bci, methodNames, expectedValues);
	}
