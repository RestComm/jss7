...
public class GenericNumberTest {
	...
	public void testEncode() throws Exception {
		...
		GenericNumberImpl prim = new GenericNumberImpl(GenericNumber._NAI_NATIONAL_SN, "12345", GenericNumber._NQIA_CONNECTED_NUMBER, GenericNumber._NPI_TELEX,
...
//		boolean numberIncomplete, int screeningIndicator		 
		...
		prim = new GenericNumberImpl(0, "", GenericNumber._NQIA_REDIRECTING_NUMBER, 0, GenericNumber._APRI_NOT_AVAILABLE, GenericNumber._NI_COMPLETE,
...
//		boolean numberIncomplete, int screeningIndicator		 
	...
	public void testXMLSerialize() throws Exception {
		...
		GenericNumberImpl original = new GenericNumberImpl(GenericNumber._NAI_NATIONAL_SN, "12345", GenericNumber._NQIA_CONNECTED_NUMBER, GenericNumber._NPI_TELEX,
				GenericNumber._APRI_ALLOWED, GenericNumber._NI_INCOMPLETE, GenericNumber._SI_USER_PROVIDED_VERIFIED_FAILED);
