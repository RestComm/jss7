...
public class GenericNumberTest extends ParameterHarness {
    ...
    public GenericNumberTest() throws IOException {
        ...
        super.goodBodies.add(getBody(GenericNumberImpl._NQIA_CONNECTED_NUMBER, false, GenericNumber._NAI_NATIONAL_SN,
                ...
                GenericNumberImpl._SI_USER_PROVIDED_VERIFIED_FAILED, getSixDigits()));

    }

    private byte[] getBody(int _NQI, boolean isODD, int _NAI, boolean _NI, int _NPI, int _APR, int _SI, byte[] digits)
            throws IOException {
    ...
    public AbstractISUPParameter getTestedComponent() {
        ...
        return new GenericNumberImpl(GenericNumber._NAI_NATIONAL_SN, getSixDigitsString(),
                GenericNumberImpl._NQIA_CONNECTED_NUMBER, GenericNumberImpl._NPI_ISDN, GenericNumberImpl._APRI_ALLOWED, false,
