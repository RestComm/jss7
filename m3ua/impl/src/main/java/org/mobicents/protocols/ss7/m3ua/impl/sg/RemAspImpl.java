...
public class RemAspImpl extends Asp {
	 ...
	 */
	protected static final XMLFormat<RemAspImpl> REM_ASP_IMPL_XML = new XMLFormat<RemAspImpl>(RemAspImpl.class) {

		@Override
		public void read(javolution.xml.XMLFormat.InputElement xml, RemAspImpl remAspImpl) throws XMLStreamException {
			ASP_XML.read(xml, remAspImpl);
		}

		@Override
		public void write(RemAspImpl remAspImpl, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
			ASP_XML.write(remAspImpl, xml);
		}
	};
