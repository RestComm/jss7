...
pushd %DIRNAME%..
set TRACE_PARSER_HOME=%CD%
echo ========
echo %TRACE_PARSER_HOME%

popd

REM Add bin/native to the PATH if present
if exist "%TRACE_PARSER_HOME%\native" set PATH=%TRACE_PARSER_HOME%\native;%PATH%
...
set RUNJAR=%TRACE_PARSER_HOME%\bin\run.jar
...
if "%TRACE_PARSER_CLASSPATH%" == "" set RUN_CLASSPATH=%RUNJAR%
if "%RUN_CLASSPATH%" == "" set RUN_CLASSPATH=%TRACE_PARSER_CLASSPATH%;%RUNJAR%

set TRACE_PARSER_CLASSPATH=%RUN_CLASSPATH%
...
set TRACE_PARSER_ENDORSED_DIRS=%TRACE_PARSER_HOME%\lib


echo ===============================================================================
echo.
echo   TRACE_PARSER Bootstrap Environment
echo.
...
echo   
echo   TRACE_PARSER_ENDORSED_DIRS: %TRACE_PARSER_ENDORSED_DIRS%
echo.
echo ===============================================================================
echo.
