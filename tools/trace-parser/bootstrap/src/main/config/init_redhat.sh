...
#
# Restcomm Trace Parser Control Script
#
...
MMS_HOME=${MMS_HOME:-"/home/abhayani/workarea/restcomm/svn/trunk/servers/media/core/server-standalone/target/mms-standalone-pojo"}
