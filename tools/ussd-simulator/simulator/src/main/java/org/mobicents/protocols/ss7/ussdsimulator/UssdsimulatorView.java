...
public class UssdsimulatorView extends FrameView implements MAPDialogListener,
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(
						org.mobicents.protocols.ss7.ussdsimulator.UssdsimulatorApp.class)
				.getContext().getResourceMap(UssdsimulatorView.class);
		cell_keypad_master_panel
				.setBorder(javax.swing.BorderFactory
						.createMatteBorder(
								...
								1,
								resourceMap
										.getColor("cell_keypad_master_panel.border.matteColor"))); // NOI18N
		cell_keypad_master_panel.setName("cell_keypad_master_panel"); // NOI18N

		cell_keypad_call_buttons_panel
				.setName("cell_keypad_call_buttons_panel"); // NOI18N

		_keypad_button_call.setText(resourceMap
				.getString("_keypad_button_call.text")); // NOI18N
		...
		_keypad_button_break.setText(resourceMap
				.getString("_keypad_button_break.text")); // NOI18N
		_keypad_button_break.setName("_keypad_button_break"); // NOI18N
		_keypad_button_break
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout cell_keypad_call_buttons_panelLayout = new org.jdesktop.layout.GroupLayout(
				cell_keypad_call_buttons_panel);
		cell_keypad_call_buttons_panel
				.setLayout(cell_keypad_call_buttons_panelLayout);
		cell_keypad_call_buttons_panelLayout
				.setHorizontalGroup(cell_keypad_call_buttons_panelLayout
						.createParallelGroup(
						...
						.add(
								cell_keypad_call_buttons_panelLayout
										...
										.addPreferredGap(
												...
												13, Short.MAX_VALUE).add(
												_keypad_button_break)
										.addContainerGap()));
		cell_keypad_call_buttons_panelLayout
				.setVerticalGroup(cell_keypad_call_buttons_panelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
		...
		_keypad_button_1
				.setText(resourceMap.getString("_keypad_button_1.text")); // NOI18N
		...
		_keypad_button_2
				.setText(resourceMap.getString("_keypad_button_2.text")); // NOI18N
		...
		_keypad_button_3
				.setText(resourceMap.getString("_keypad_button_3.text")); // NOI18N
		...
		_keypad_button_4
				.setText(resourceMap.getString("_keypad_button_4.text")); // NOI18N
		...
		_keypad_button_5
				.setText(resourceMap.getString("_keypad_button_5.text")); // NOI18N
		...
		_keypad_button_6
				.setText(resourceMap.getString("_keypad_button_6.text")); // NOI18N
		...
		_keypad_button_7
				.setText(resourceMap.getString("_keypad_button_7.text")); // NOI18N
		...
		_keypad_button_8
				.setText(resourceMap.getString("_keypad_button_8.text")); // NOI18N
		...
		_keypad_button_9
				.setText(resourceMap.getString("_keypad_button_9.text")); // NOI18N
		...
		_keypad_button_star.setText(resourceMap
				.getString("_keypad_button_star.text")); // NOI18N
		...
		_keypad_button_0
				.setText(resourceMap.getString("_keypad_button_0.text")); // NOI18N
		...
		_keypad_button_hash.setText(resourceMap
				.getString("_keypad_button_hash.text")); // NOI18N
		...
		org.jdesktop.layout.GroupLayout cell_keypad_master_panelLayout = new org.jdesktop.layout.GroupLayout(
				cell_keypad_master_panel);
		cell_keypad_master_panel.setLayout(cell_keypad_master_panelLayout);
		cell_keypad_master_panelLayout
				.setHorizontalGroup(cell_keypad_master_panelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								cell_keypad_master_panelLayout
										...
										.addContainerGap(
												...
												Short.MAX_VALUE)));
		cell_keypad_master_panelLayout
				.setVerticalGroup(cell_keypad_master_panelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								cell_keypad_master_panelLayout
		...
		_label_peer_port
				.setText(resourceMap.getString("_label_peer_port.text")); // NOI18N
		_label_peer_port.setName("_label_peer_port"); // NOI18N

		_field_peer_port
				.setText(resourceMap.getString("_field_peer_port.text")); // NOI18N
		_field_peer_port.setName("_field_peer_port"); // NOI18N

		_button_open_server.setText(resourceMap
				.getString("_button_open_server.text")); // NOI18N
		...
		_button_close_server.setText(resourceMap
				.getString("_button_close_server.text")); // NOI18N
		_button_close_server.setEnabled(false);
		_button_close_server.setName("_button_close_server"); // NOI18N
		_button_close_server
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application
				.getInstance(
						org.mobicents.protocols.ss7.ussdsimulator.UssdsimulatorApp.class)
				.getContext().getActionMap(UssdsimulatorView.class, this);
		...
		this.initSS7Future = this._EXECUTOR.schedule(new Runnable() {
			...
			public void run() {
				...
				if (!mtpLayer.isLinkUp()) {
					...
					peer1Address = sccpProvider.getSccpParameterFactory()
							.getSccpAddress();
					GlobalTitle gt = sccpProvider.getSccpParameterFactory()
							.getGlobalTitle100();
					...
					peer2Address = sccpProvider.getSccpParameterFactory()
							.getSccpAddress();
					gt = sccpProvider.getSccpParameterFactory()
							.getGlobalTitle100();
					// dont set more, until statics are defined!
	...
	private void _keypad_button_callActionPerformed(
		...
		if (this.clientDialog == null) {
			try {
				this.clientDialog = mapProvider.createNewDialog(
						this.mapUssdAppContext, this.peer1Address,
						orgiReference, this.peer2Address, destReference);
	...
	private void initSS7() throws Exception {
		...
		Properties sccpProps = new java.util.Properties();
		sccpProps.setProperty(AbstractSccpProviderImpl.CONFIG_OPC, "0");
		sccpProps.setProperty(AbstractSccpProviderImpl.CONFIG_DPC, "0");
		sccpProps.setProperty(AbstractSccpProviderImpl.CONFIG_SLS, "0");
		sccpProps.setProperty(AbstractSccpProviderImpl.CONFIG_SSI, "3");

		this.sccpProvider = new SccpDefaultProviderImpl(this.mtpLayer);
		this.sccpProvider.configure(sccpProps);
