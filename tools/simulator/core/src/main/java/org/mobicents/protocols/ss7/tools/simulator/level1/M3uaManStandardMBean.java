...
public class M3uaManStandardMBean extends StandardMBean {
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        MBeanAttributeInfo[] attributes = new MBeanAttributeInfo[] {
                ...
                new MBeanAttributeInfo("M3uaExchangeType", M3uaExchangeType.class.getName(), "M3ua exchange type: SE or DE",
                        true, true, false),
                new MBeanAttributeInfo("M3uaExchangeType_Value", String.class.getName(), "M3ua exchange type", true, false,
                        false), new MBeanAttributeInfo("M3uaDpc", int.class.getName(), "Dpc", true, true, false),
