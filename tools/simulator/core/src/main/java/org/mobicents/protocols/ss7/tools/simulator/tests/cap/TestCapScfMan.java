...
public class TestCapScfMan extends TesterBase implements TestCapScfManMBean, Stoppable, CAPDialogListener, CAPServiceCircuitSwitchedCallListener {
	...
	private CapApplicationContextScf capProtocolVersion = new CapApplicationContextScf(CapApplicationContextScf.VAL_CAP_V4_capscf_ssfGeneric);
	...
	protected static final XMLFormat<TestCapScfMan> XML = new XMLFormat<TestCapScfMan>(TestCapScfMan.class) {

		public void write(TestCapScfMan srv, OutputElement xml) throws XMLStreamException {
			xml.add(srv.capProtocolVersion.toString(), CAP_PROTOCOL_VERSION);
		}

		public void read(InputElement xml, TestCapScfMan srv) throws XMLStreamException {
			String cpv = (String) xml.get(CAP_PROTOCOL_VERSION, String.class);
			srv.capProtocolVersion = CapApplicationContextScf.createInstance(cpv);
		}
	};
