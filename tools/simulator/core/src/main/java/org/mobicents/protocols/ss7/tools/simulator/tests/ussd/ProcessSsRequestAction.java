...
public class ProcessSsRequestAction extends EnumeratedBase {
	...
	static {
		...
		intMap.put(VAL_AUTO_Unstructured_SS_Request_Then_ProcessUnstructuredSSResponse, "Auto sending Send Unstructured_SS_Request then after response sending ProcessUnstructuredSSResponse");
		...
		stringMap.put("Auto sending Send Unstructured_SS_Request then after response sending ProcessUnstructuredSSResponse", VAL_AUTO_Unstructured_SS_Request_Then_ProcessUnstructuredSSResponse);
	}
