...
public class TestSmsServerStandardManMBean extends StandardMBean {
	...
	public TestSmsServerStandardManMBean(TestSmsServerMan impl, Class<TestSmsServerManMBean> intf) throws NotCompliantMBeanException {
		super(impl, intf);
	}
	...
	public MBeanInfo getMBeanInfo() {
		...
		MBeanAttributeInfo[] attributes = new MBeanAttributeInfo[] { 
				...
				new MBeanAttributeInfo("ServiceCenterAddress", String.class.getName(), "Origination Service center address string", true, true, false),
				...
				new MBeanAttributeInfo("HlrSsn", int.class.getName(), "HLR SSN for outgoing SccpAddress (default value: 6)", true, true, false),
				new MBeanAttributeInfo("VlrSsn", int.class.getName(), "VLR SSN for outgoing SccpAddress (default value: 8)", true, true, false),
				new MBeanAttributeInfo("TypeOfNumber", TypeOfNumberType.class.getName(), "TypeOfNumber parameter for SMS tpdu origAddress", true, true, false),
		...
		MBeanOperationInfo[] operations = new MBeanOperationInfo[] {
				new MBeanOperationInfo("performSRIForSM", "Send sendRoutingInfoForSM request", performSRIForSMParam, String.class.getName(), MBeanOperationInfo.ACTION),
				new MBeanOperationInfo("performSRIForSM_MtForwardSM", "Send sendRoutingInfoForSM request and after a response send mt-forwardSM request", 
				...
				new MBeanOperationInfo("putMapProtocolVersion", "MAP protocol version: " +
						"1, 2 or 3", 
						signString, Void.TYPE.getName(), MBeanOperationInfo.ACTION),
				new MBeanOperationInfo("putTypeOfNumber", "TypeOfNumber parameter for SMS tpdu origAddress: " +
						...
						signString, Void.TYPE.getName(), MBeanOperationInfo.ACTION),
				new MBeanOperationInfo("putNumberingPlanIdentification", "NumberingPlanIdentification parameter for SMS tpdu origAddress: " +
		...
		return new MBeanInfo(TestSmsServerMan.class.getName(), "SmsServer test parameters management", attributes, null, operations, null);
	}
}
