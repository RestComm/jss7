...
public class TestSmsClientStandardManMBean extends StandardMBean {
    ...
    public TestSmsClientStandardManMBean(TestSmsClientMan impl, Class<TestSmsClientManMBean> intf)
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        MBeanAttributeInfo[] attributes = new MBeanAttributeInfo[] {
                ...
                new MBeanAttributeInfo("ServiceCenterAddress", String.class.getName(),
                        "Destination Service center address string", true, true, false),
                ...
                new MBeanAttributeInfo("SRIInformServiceCenter", SRIInformServiceCenter.class.getName(),
                        "SRI response - InformServiceCenter", true, true, false),
                new MBeanAttributeInfo("SRIInformServiceCenter_Value", String.class.getName(),
                        "SRI response - InformServiceCenter", true, false, false),
                new MBeanAttributeInfo("SRIScAddressNotIncluded", Boolean.class.getName(),
                        "SRI response ServiceCenter Address is not included in MWD", true, true, true),
                ...
                new MBeanAttributeInfo("SRIResponseImsi", String.class.getName(),
                        "IMSI for auto sendRoutingInfoForSM response", true, true, false),
                new MBeanAttributeInfo("SRIResponseVlr", String.class.getName(),
                        "VLR address for auto sendRoutingInfoForSM response", true, true, false),
                new MBeanAttributeInfo("SmscSsn", int.class.getName(), "SMSC SSN for outgoing SccpAddress (default value: 8)",
                        true, true, false),
                new MBeanAttributeInfo("TypeOfNumber", TypeOfNumberType.class.getName(),
                        "TypeOfNumber parameter for SMS tpdu destAddress", true, true, false),
                new MBeanAttributeInfo("TypeOfNumber_Value", String.class.getName(),
                        "TypeOfNumber parameter for SMS tpdu destAddress", true, false, false),
                ...
                new MBeanAttributeInfo("CurrentRequestDef", String.class.getName(), "Get information of the current request",
                        true, false, false),
                new MBeanAttributeInfo("SmsCodingType", SmsCodingType.class.getName(), "Character set for SMS encoding", true,
                        true, false),
        ...
        MBeanParameterInfo[] performMoForwardSMPartial = new MBeanParameterInfo[] {
                ...
                new MBeanParameterInfo("segmCnt", Integer.class.getName(),
        ...
        MBeanOperationInfo[] operations = new MBeanOperationInfo[] {
                ...
                new MBeanOperationInfo("performMoForwardSMPartial",
                        "Send mo-forwardSM request that contain a part of contatenated message", performMoForwardSMPartial,
                        String.class.getName(), MBeanOperationInfo.ACTION),
                ...
                new MBeanOperationInfo("putSRIInformServiceCenter", "SRI response - InformServiceCenter: "
                        + "1:MwdNo,2:MwdMcef,3:MwdMnrf,4:MwdMcefMnrf,5:MwdMnrg", signString, Void.TYPE.getName(),
                        MBeanOperationInfo.ACTION),
                new MBeanOperationInfo(
                        "putMtFSMReaction",
                        "MtFSM response type: "
        ...
        return new MBeanInfo(TestSmsClientMan.class.getName(), "SmsClient test parameters management", attributes, null,
                operations, null);
    }
